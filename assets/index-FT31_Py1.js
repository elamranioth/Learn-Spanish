const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chapter-content-CZa5kO51.js","assets/react-iLQ0ojkV.js","assets/icons-CkpqrV9P.js","assets/dictionary-popup-CXQYiWmd.js","assets/memoria-view-BqzxBarN.js","assets/sync-panel-enra1fBN.js"])))=>i.map(i=>d[i]);
import{r as c,j as n,R as D,c as _t}from"./react-iLQ0ojkV.js";import{X as an,G as wa,C as xe,B as sn,T as Ft,a as Ht,Z as ua,b as $t,c as No,d as Ao,D as Po,V as ga,H as Do,S as Ee,M as Vt,L as Wt,e as Mo,f as fa,g as Yt,h as ao,i as Kt,j as Jt,k as Qt,l as Xt}from"./icons-CkpqrV9P.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))t(s);new MutationObserver(s=>{for(const i of s)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function a(s){const i={};return s.integrity&&(i.integrity=s.integrity),s.referrerPolicy&&(i.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?i.credentials="include":s.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(s){if(s.ep)return;s.ep=!0;const i=a(s);fetch(s.href,i)}})();function Zt(){typeof window>"u"||!("serviceWorker"in navigator)||window.addEventListener("load",()=>{const e="/Learn-Spanish/";navigator.serviceWorker.register(`${e}sw.js?v=${encodeURIComponent("2026-06-08T04:20:09.046Z")}`,{scope:e,updateViaCache:"none"}).then(a=>{function t(s){window.dispatchEvent(new CustomEvent("learn-spanish-update-ready",{detail:{worker:s}}))}a.waiting&&navigator.serviceWorker.controller&&t(a.waiting),a.addEventListener("updatefound",()=>{const s=a.installing;s&&s.addEventListener("statechange",()=>{s.state==="installed"&&navigator.serviceWorker.controller&&t(s)})}),a.update().catch(()=>{})}).catch(()=>{}),navigator.serviceWorker.addEventListener("controllerchange",()=>{window.__learnSpanishRefreshing||(window.__learnSpanishRefreshing=!0,window.location.reload())})})}const er="modulepreload",nr=function(e){return"/Learn-Spanish/"+e},oo={},ee=function(o,a,t){let s=Promise.resolve();if(a&&a.length>0){let u=function(h){return Promise.all(h.map(m=>Promise.resolve(m).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=l?.nonce||l?.getAttribute("nonce");s=u(a.map(h=>{if(h=nr(h),h in oo)return;oo[h]=!0;const m=h.endsWith(".css"),b=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${b}`))return;const w=document.createElement("link");if(w.rel=m?"stylesheet":er,m||(w.as="script"),w.crossOrigin="",w.href=h,d&&w.setAttribute("nonce",d),document.head.appendChild(w),m)return new Promise((E,N)=>{w.addEventListener("load",E),w.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${h}`)))})}))}function i(l){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=l,window.dispatchEvent(d),!d.defaultPrevented)throw l}return s.then(l=>{for(const d of l||[])d.status==="rejected"&&i(d.reason);return o().catch(i)})};function Tn(e,o={}){typeof window>"u"||window.dispatchEvent(new CustomEvent("learn-spanish-message",{detail:{id:`${Date.now()}-${Math.random().toString(16).slice(2)}`,title:o.title||"Notice",message:e,tone:o.tone||"info",timeout:o.timeout||5200}}))}function ar(){const[e,o]=c.useState([]);return c.useEffect(()=>{function a(t){const s=t.detail||{};s.message&&(o(i=>[s,...i].slice(0,3)),s.timeout!==1/0&&window.setTimeout(()=>{o(i=>i.filter(l=>l.id!==s.id))},s.timeout||5200))}return window.addEventListener("learn-spanish-message",a),()=>window.removeEventListener("learn-spanish-message",a)},[]),e.length?n.jsx("div",{className:"app-message-stack","aria-live":"polite","aria-atomic":"false",children:e.map(a=>n.jsxs("div",{className:`app-message app-message-${a.tone||"info"}`,children:[n.jsxs("div",{children:[n.jsx("span",{className:"app-message-title",children:a.title}),n.jsx("p",{children:a.message})]}),n.jsx("button",{type:"button",className:"app-message-close",onClick:()=>o(t=>t.filter(s=>s.id!==a.id)),"aria-label":"Dismiss message",children:n.jsx(an,{size:14})})]},a.id))}):null}function aa(){if(typeof window>"u"||typeof navigator>"u")return{isPhone:!1,isReaderTablet:!1,isCoarsePointer:!1,classes:"device-desktop"};const e=navigator.userAgent||"",o=(navigator.userAgentData?.brands||[]).map(m=>m.brand).join(" "),a=window.innerWidth||document.documentElement?.clientWidth||0,t=window.innerHeight||document.documentElement?.clientHeight||0,s=Math.min(a,t),i=Math.max(a,t),l=window.matchMedia?.("(pointer: coarse)")?.matches||!1,d=s<=520&&l,u=/boox|onyx|e-?ink/i.test(`${e} ${o}`)||s>=560&&i>=850&&l,h=[d?"device-phone":"",u?"device-reader-tablet":"",l?"device-touch":"device-desktop"].filter(Boolean).join(" ");return{isPhone:d,isReaderTablet:u,isCoarsePointer:l,classes:h}}function or({insights:e=[],onAction:o}){return e.length?n.jsxs("section",{className:"teacher-panel","aria-label":"Teacher recommendations",children:[n.jsxs("div",{className:"home-section-heading",children:[n.jsx(wa,{size:18}),"Teacher notes"]}),n.jsx("div",{className:"teacher-card-grid",children:e.map(a=>n.jsxs("button",{className:"teacher-card",onClick:()=>o?.(a.action),children:[n.jsx("span",{className:"teacher-card-title",children:a.title}),n.jsx("span",{className:"teacher-card-detail",children:a.detail}),n.jsxs("span",{className:"teacher-card-action",children:[a.actionLabel||"Open",n.jsx(xe,{size:14})]})]},a.key))})]}):null}function to({icon:e,label:o,value:a,detail:t}){return n.jsxs("div",{className:"teacher-metric",children:[n.jsx(e,{size:16}),n.jsx("span",{children:o}),n.jsx("strong",{children:a}),n.jsx("em",{children:t})]})}function tr({totalLessons:e,visitedCount:o,savedWordsCount:a,levelFilter:t,palabrasSummary:s,lessonSummary:i,memoriaSummary:l,learnerProfile:d,reviewQueue:u,dailyPlan:h,dailyProgress:m,teacherInsights:b,sectionProgress:w,recommendations:E,onStart:N,onStartDaily:I,onDailyStep:q,onOpenMemoria:y,onOpenPalabras:j,onOpenVerb:L,onOpenReading:G,onSelectChapter:M,onTeacherAction:B}){const te=e?Math.round(o/e*100):0,H=h.find(k=>!k.complete)||h[0],J=b?.[0]||{title:"Begin today gently",detail:"Open the next lesson, read one page, then save one useful word in Memoria.",action:"daily",actionLabel:"Start"},z=i?.mastered||0,_=J.action||"daily";return n.jsxs("article",{className:"chapter-body home-dashboard",children:[n.jsxs("header",{className:"home-hero",children:[n.jsxs("div",{className:"home-kicker",children:[n.jsx(wa,{size:18}),"Daily Teacher Mode"]}),n.jsx("h1",{className:"home-title",children:"Lexiora"}),n.jsx("p",{className:"home-subtitle",children:"A calm Spanish study room: one lesson, one review queue, one clear next action."}),n.jsxs("div",{className:"home-actions",children:[n.jsxs("button",{className:"home-primary",onClick:I||N,children:["Start Daily Lesson",n.jsx(xe,{size:16})]}),n.jsxs("button",{className:"home-secondary",onClick:y,children:[n.jsx(sn,{size:15}),"Memoria"]})]})]}),n.jsxs("section",{className:"daily-teacher-panel","aria-label":"Daily teacher mode",children:[n.jsxs("div",{className:"daily-teacher-main",children:[n.jsxs("span",{className:"home-section-heading",children:[n.jsx(Ft,{size:18}),"Teacher focus"]}),n.jsx("h2",{children:J.title}),n.jsx("p",{children:J.detail}),n.jsxs("div",{className:"daily-teacher-actions",children:[n.jsxs("button",{onClick:()=>B?.(_),children:[J.actionLabel||"Open",n.jsx(xe,{size:15})]}),H&&n.jsxs("button",{className:"secondary",onClick:()=>q(H.key),children:["Next: ",H.title]})]})]}),n.jsxs("div",{className:"daily-teacher-card",children:[n.jsxs("span",{children:[m.completed," / ",m.total]}),n.jsx("strong",{children:"Today"}),n.jsxs("em",{children:[m.completed," done today"]})]})]}),n.jsxs("section",{className:"teacher-metrics","aria-label":"Today's study metrics",children:[n.jsx(to,{icon:Ht,label:"Mastery",value:z,detail:`${i.understood} understood`}),n.jsx(to,{icon:sn,label:"Memoria",value:a,detail:`${l.due} due`})]}),n.jsx(or,{insights:b,onAction:B}),n.jsxs("section",{className:"home-stats","aria-label":"Study progress",children:[n.jsxs("div",{className:"home-stat",children:[n.jsx("span",{className:"home-stat-label",children:"Progreso"}),n.jsxs("strong",{children:[te,"%"]}),n.jsxs("span",{children:[o," / ",e," lecciones"]})]}),n.jsxs("div",{className:"home-stat",children:[n.jsx("span",{className:"home-stat-label",children:"Nivel"}),n.jsx("strong",{children:t==="ALL"?"Todo":t}),n.jsx("span",{children:"Filtro activo"})]}),n.jsxs("div",{className:"home-stat",children:[n.jsx("span",{className:"home-stat-label",children:"Palabras due"}),n.jsx("strong",{children:s.due}),n.jsxs("span",{children:[s.mastered," dominadas"]})]}),n.jsxs("div",{className:"home-stat",children:[n.jsx("span",{className:"home-stat-label",children:"Lecciones"}),n.jsx("strong",{children:i.understood}),n.jsxs("span",{children:[i.read," leidas"]})]})]}),n.jsxs("section",{className:"home-daily",children:[n.jsxs("div",{className:"home-section-heading",children:[n.jsx(ua,{size:18}),"Ruta diaria"]}),n.jsx("div",{className:"home-daily-grid",children:h.map(k=>n.jsxs("button",{className:`home-daily-step ${k.complete?"complete":""}`,onClick:()=>q(k.key),children:[n.jsx("span",{children:k.index}),n.jsx("strong",{children:k.title}),n.jsx("em",{children:k.detail}),n.jsx("small",{children:k.complete?"Done":"Open"})]},k.key))})]}),n.jsxs("section",{className:"home-review-queue",children:[n.jsxs("div",{className:"home-section-heading",children:[n.jsx($t,{size:18}),"Cola de repaso"]}),n.jsx("div",{className:"home-review-list",children:u.slice(0,8).map((k,$)=>n.jsxs("button",{onClick:()=>k.chapter?M(k.chapter):y(),children:[n.jsx("span",{className:`review-type ${k.type}`,children:k.type}),n.jsx("strong",{children:k.title}),n.jsx("em",{children:k.detail})]},`${k.type}-${k.title}-${$}`))}),n.jsxs("div",{className:"home-review-summary",children:[d.vocabulary.due," vocabulary due - ",d.chapters.unvisited," lesson groups to open"]})]}),n.jsxs("section",{className:"home-progress-map",children:[n.jsxs("div",{className:"home-section-heading",children:[n.jsx(No,{size:18}),"Mapa de progreso"]}),n.jsx("div",{className:"home-progress-list",children:w.map(k=>{const $=k.total?Math.round(k.visited/k.total*100):0;return n.jsxs("div",{className:"home-progress-row",children:[n.jsxs("div",{className:"home-progress-top",children:[n.jsx("span",{children:k.label}),n.jsxs("strong",{children:[k.visited," / ",k.total]})]}),n.jsx("div",{className:"home-progress-track",children:n.jsx("span",{style:{width:`${$}%`}})})]},k.id)})})]}),n.jsxs("section",{className:"home-path",children:[n.jsxs("div",{className:"home-section-heading",children:[n.jsx(Ao,{size:18}),"Siguiente lectura"]}),n.jsx("div",{className:"home-recommendations",children:E.map((k,$)=>n.jsxs("button",{className:"home-rec",onClick:()=>M(k),children:[n.jsx("span",{className:"home-rec-index",children:String($+1).padStart(2,"0")}),n.jsxs("span",{className:"home-rec-main",children:[n.jsx("span",{className:"home-rec-title",children:k.title}),n.jsxs("span",{className:"home-rec-meta",children:[k.sectionLabel," - ",k.level]})]}),n.jsx(xe,{size:16})]},k.id))})]})]})}function rr({installReady:e,installMessage:o,onInstall:a,onDismiss:t}){return n.jsxs("div",{className:"install-banner",children:[n.jsxs("div",{className:"resume-banner-text",children:[n.jsx("span",{className:"resume-banner-label",children:"Install Lexiora"}),n.jsx("span",{className:"resume-banner-title",children:e?"Add the app to this device":"Add to Home Screen if your browser hides the icon"}),o&&n.jsx("span",{className:"install-banner-message",children:o})]}),n.jsxs("div",{className:"resume-banner-actions",children:[n.jsxs("button",{className:"resume-btn-primary install-btn-primary",onClick:a,children:[n.jsx(Po,{size:15}),"Install"]}),n.jsx("button",{className:"resume-btn-dismiss",onClick:t,"aria-label":"Dismiss install banner",children:n.jsx(an,{size:15})})]})]})}let Ge=null,ro=!1,Ke={rate:.85,voiceURI:""};function Go(){return Math.max(.65,Math.min(1.25,Number(Ke.rate)||.85))}function on(e={}){Ke={...Ke,...e,rate:Math.max(.65,Math.min(1.25,Number(e.rate??Ke.rate)||.85))},Ge=null}function Uo(){return typeof window>"u"||!window.speechSynthesis?[]:window.speechSynthesis.getVoices()||[]}function so(){return Uo().filter(e=>e.lang&&e.lang.toLowerCase().startsWith("es")||/spanish|espanol|espaÃ±ol/i.test(e.name||""))}function We(){if(typeof window>"u"||!window.speechSynthesis)return null;if(Ge)return Ge;const e=Uo();if(e.length===0)return null;if(Ke.voiceURI){const t=e.find(s=>s.voiceURI===Ke.voiceURI);if(t)return Ge=t,t}const o=["es-ES","es-MX","es-US","es-AR","es-CO","es-419","es"];for(const t of o){const s=e.find(i=>i.lang&&i.lang.toLowerCase().startsWith(t.toLowerCase()));if(s)return Ge=s,s}const a=e.find(t=>/spanish|español/i.test(t.name||""));return a?(Ge=a,a):null}typeof window<"u"&&window.speechSynthesis&&(window.speechSynthesis.addEventListener?.("voiceschanged",()=>{Ge=null,We()}),We(),setTimeout(We,250),setTimeout(We,1e3));function ka(){if(!ro&&!(typeof window>"u"||!window.speechSynthesis))try{const e=new SpeechSynthesisUtterance(" ");e.volume=0,e.rate=1,window.speechSynthesis.speak(e),ro=!0}catch{}}function ln(){try{window.speechSynthesis?.cancel(),window.dispatchEvent?.(new CustomEvent("learn-spanish-audio-stop"))}catch{}}function Ro(e,o={}){if(typeof window>"u"||!window.speechSynthesis||!e)return o.onerror&&o.onerror({error:"no-speechSynthesis"}),null;try{window.speechSynthesis.cancel();const a=new SpeechSynthesisUtterance(e),t=We();t&&(a.voice=t),a.lang=t?.lang||"es-ES",a.rate=o.rate??Go(),a.pitch=o.pitch??1,a.volume=1,o.onend&&(a.onend=o.onend),o.onerror&&(a.onerror=l=>{console.warn("[speech] error:",l?.error||"unknown",{text:e.slice(0,30),voice:t?.name}),o.onerror(l)}),o.onboundary&&(a.onboundary=o.onboundary),o.onstart&&(a.onstart=o.onstart),window.speechSynthesis.speak(a);const s=setInterval(()=>{if(!window.speechSynthesis.speaking){clearInterval(s);return}window.speechSynthesis.pause(),window.speechSynthesis.resume()},14e3),i=a.onend;return a.onend=l=>{clearInterval(s),i&&i(l)},a}catch(a){return console.warn("[speech] threw:",a),o.onerror&&o.onerror({error:a.message}),null}}const io=/([\p{L}\p{N}]+)|([^\p{L}\p{N}]+)/gu;function Oo(e){const o=[],a=String(e||"");let t;for(io.lastIndex=0;(t=io.exec(a))!==null;)o.push({text:t[0],isWord:!!t[1],charStart:t.index});return o}function ha({text:e}){const o=c.useMemo(()=>Oo(e),[e]);return n.jsx(n.Fragment,{children:o.map((a,t)=>a.isWord?n.jsx("span",{className:"dict-word-token","data-dict-word":a.text,children:a.text},t):n.jsx("span",{children:a.text},t))})}function Vs({text:e,paragraphClass:o="reading-paragraph",firstParagraph:a=!1}){const t=c.useMemo(()=>Oo(e),[e]),s=c.useMemo(()=>{const I=[];let q="",y=[],j=-1;function L(){y.length>0&&I.push({spokenText:q.trim(),words:y}),q="",y=[],j=-1}for(let G=0;G<t.length;G++){const M=t[G];if(!M.isWord&&y.length===0&&/^\s+$/.test(M.text))continue;const B=q.length;q+=M.text,M.isWord?(y.push({tokenIdx:G,text:M.text,charStart:B,charEnd:B+M.text.length,commaAfter:!1}),j=y.length-1):(/,/.test(M.text)&&j>=0&&(y[j].commaAfter=!0),/[.!?;:]/.test(M.text)&&L())}return L(),I},[t]),[i,l]=c.useState(-1),[d,u]=c.useState(!1),h=D.useRef([]),m=D.useRef([]),b=D.useRef(!1),w=D.useRef(110);function E(){m.current.forEach(clearTimeout),m.current=[]}function N(I){if(I.stopPropagation(),typeof window>"u"||!window.speechSynthesis){Tn("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(ka(),d){b.current=!0,ln(),E(),u(!1),l(-1);return}if(s.length===0)return;ln(),E(),b.current=!1,u(!0),w.current=110;let q=0;function y(){if(b.current)return;if(q>=s.length){u(!1),l(-1);return}const j=s[q];if(!j||j.words.length===0){q++,y();return}const L=new SpeechSynthesisUtterance(j.spokenText),G=We();G&&(L.voice=G),L.lang=G?.lang||"es-ES",L.rate=Go(),L.pitch=1;let M=!1,B=!1,te=!1,H=!1,J=0;const z=30,_=200;function k(U){const X=Math.max(0,Number(U)||0);let V=j.words[0];for(const le of j.words)if(le.charStart<=X+1)V=le;else break;return V}function $(){if(H||te||b.current)return;H=!0;let U=0;for(let X=0;X<j.words.length;X++){const V=j.words[X],ge=setTimeout(()=>{!b.current&&!te&&l(V.tokenIdx)},U);m.current.push(ge),U+=V.text.length*w.current+z,V.commaAfter&&(U+=_)}}L.onstart=()=>{if(M)return;M=!0,J=performance.now();const U=setTimeout($,350);m.current.push(U)},L.onboundary=U=>{if(b.current||typeof U.charIndex!="number")return;const X=k(U.charIndex);X&&(te=!0,l(X.tokenIdx))};const Q=setTimeout(()=>{!M&&!b.current&&(M=!0,J=performance.now(),$())},500);m.current.push(Q);function Te(){if(B||(B=!0,b.current))return;if(J>0){const X=performance.now()-J,V=j.words.reduce((Z,Ce)=>Z+Ce.text.length,0),le=j.words.filter(Z=>Z.commaAfter).length,ge=j.words.length*z+le*_,Re=Math.max(100,X-ge);if(V>0){const Z=Re/V;Z>=40&&Z<=300&&(w.current=Z*.6+w.current*.4)}}E(),q++;const U=setTimeout(y,30);m.current.push(U)}L.onend=Te,L.onerror=Te;const Ue=Math.max(5e3,j.spokenText.length*220),ye=setTimeout(Te,Ue);m.current.push(ye),window.speechSynthesis.speak(L)}y()}return c.useEffect(()=>{function I(){b.current=!0,E(),u(!1),l(-1)}return window.addEventListener?.("learn-spanish-audio-stop",I),()=>{b.current=!0,E(),window.removeEventListener?.("learn-spanish-audio-stop",I),window.speechSynthesis?.cancel()}},[]),c.useEffect(()=>{if(i<0)return;const I=h.current[i];if(!I||typeof I.getBoundingClientRect!="function")return;const q=I.getBoundingClientRect(),y=window.innerHeight||document.documentElement.clientHeight;(q.bottom>y-100||q.top<80)&&I.scrollIntoView({behavior:"smooth",block:"center"})},[i]),typeof window<"u"&&!window.speechSynthesis?n.jsxs("p",{className:o,children:[n.jsx("button",{className:"speak-btn speak-btn-sm paragraph-speak",onClick:I=>{I.stopPropagation(),Tn("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"})},"aria-label":"Audio not supported",title:"Audio no disponible",children:n.jsx(ga,{size:12})}),n.jsx(ha,{text:e})]}):n.jsxs("p",{className:`${o} karaoke-paragraph ${d?"is-playing":""}`,children:[n.jsx("button",{className:`speak-btn speak-btn-sm paragraph-speak ${d?"playing":""}`,onClick:N,onPointerDown:I=>I.stopPropagation(),"aria-label":d?"Stop":"Play audio with highlighting",title:d?"Detener":"Escuchar con resaltado",children:n.jsx(ga,{size:12})}),t.map((I,q)=>{if(!I.isWord)return n.jsx("span",{className:"kt-space",children:I.text},q);const y=q===i;return n.jsx("span",{ref:j=>h.current[q]=j,className:`kt-word ${y?"kt-active":""}`,"data-dict-word":I.text,children:I.text},q)})]})}function Cn({text:e,size:o="sm",className:a=""}){const[t,s]=c.useState(!1);c.useEffect(()=>{function l(){s(!1)}return window.addEventListener?.("learn-spanish-audio-stop",l),()=>window.removeEventListener?.("learn-spanish-audio-stop",l)},[]);function i(l){if(l.stopPropagation(),typeof window>"u"||!window.speechSynthesis){Tn("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(ka(),t){ln(),s(!1);return}ln(),s(!0),Ro(e,{onend:()=>s(!1),onerror:d=>{s(!1),d?.error&&d.error!=="canceled"&&d.error!=="interrupted"&&Tn(`Error al leer: ${d.error}. Asegurate de tener una voz en espanol instalada.`,{title:"Audio necesita atencion",tone:"warning"})}})}return n.jsx("button",{className:`speak-btn speak-btn-${o} ${t?"playing":""} ${a}`,onClick:i,onPointerDown:l=>l.stopPropagation(),"aria-label":t?"Stop":"Play audio",title:t?"Detener":"Escuchar",children:n.jsx(ga,{size:o==="sm"?12:14})})}function sr({settings:e,onChange:o}){const[a,t]=c.useState(()=>so());c.useEffect(()=>{on(e)},[e]),c.useEffect(()=>{function i(){t(so())}if(i(),typeof window<"u"&&window.speechSynthesis){window.speechSynthesis.addEventListener?.("voiceschanged",i);const l=setTimeout(i,600);return()=>{clearTimeout(l),window.speechSynthesis.removeEventListener?.("voiceschanged",i)}}},[]);function s(i){const l={...e,...i};on(l),o?.(l)}return n.jsxs("div",{className:"audio-settings","aria-label":"Audio settings",children:[n.jsxs("div",{className:"audio-settings-label",children:[n.jsx(Do,{size:14}),"Audio"]}),n.jsxs("select",{className:"audio-rate-select",value:String(e.rate),onChange:i=>s({rate:Number(i.target.value)}),"aria-label":"Audio speed",children:[n.jsx("option",{value:"0.7",children:"0.70x"}),n.jsx("option",{value:"0.85",children:"0.85x"}),n.jsx("option",{value:"1",children:"1.00x"}),n.jsx("option",{value:"1.15",children:"1.15x"})]}),n.jsxs("select",{className:"audio-voice-select",value:e.voiceURI||"",onChange:i=>s({voiceURI:i.target.value}),"aria-label":"Spanish voice",children:[n.jsx("option",{value:"",children:"Voz espanola"}),a.map(i=>n.jsxs("option",{value:i.voiceURI,children:[i.name," (",i.lang,")"]},i.voiceURI))]})]})}function Ws({es:e,en:o,esClass:a="vu-ex-es",enClass:t="vu-ex-en"}){const s=(e||"").length,i=(o||"").length;return s<=18&&i<=18&&s+i<=36?n.jsxs("div",{className:`${a} inline-pair`,children:[n.jsx(Cn,{text:e}),n.jsx(ha,{text:e})," ",n.jsxs("span",{className:`${t} inline-en`,children:["(",o,")"]})]}):n.jsxs(n.Fragment,{children:[n.jsxs("div",{className:a,children:[n.jsx(Cn,{text:e}),n.jsx(ha,{text:e})]}),n.jsx("div",{className:t,children:o})]})}const ir=`
