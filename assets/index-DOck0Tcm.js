...
import{r as p,j as e,R as oe,c as ys}from"./react-iLQ0ojkV.js";import{X as Je,G as bt,C as Re,B as wa,T as ws,a as ao,b as ks,P as xt,Z as ct,c as js,d as vt,D as vn,H as yn,V as pt,S as ze,M as Ns,L as Ta,e as wn,f as Co,g as zs,h as mt,i as Pa,j as Ss,k as Is,l as Cs,m as bo,n as xo,o as To,N as yt,R as wt,p as to}from"./icons-CNhzGsg5.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function o(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=o(s);fetch(s.href,r)}})();function Es(){typeof window>"u"||!("serviceWorker"in navigator)||window.addEventListener("load",()=>{const a="/Learn-Spanish/";navigator.serviceWorker.register(`${a}sw.js?v=${encodeURIComponent("2026-06-02T13:46:56.872Z")}`,{scope:a,updateViaCache:"none"}).then(o=>{function n(s){s?.postMessage?.({type:"SKIP_WAITING"}),window.dispatchEvent(new CustomEvent("learn-spanish-update-ready",{detail:{worker:s}}))}o.waiting&&navigator.serviceWorker.controller&&n(o.waiting),o.addEventListener("updatefound",()=>{const s=o.installing;s&&s.addEventListener("statechange",()=>{s.state==="installed"&&navigator.serviceWorker.controller&&n(s)})}),o.update().catch(()=>{})}).catch(()=>{}),navigator.serviceWorker.addEventListener("controllerchange",()=>{window.__learnSpanishRefreshing||(window.__learnSpanishRefreshing=!0,window.location.reload())})})}const qs="modulepreload",As=function(a){return"/Learn-Spanish/"+a},Vt={},Le=function(t,o,n){let s=Promise.resolve();if(o&&o.length>0){let g=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),d=i?.nonce||i?.getAttribute("nonce");s=g(o.map(c=>{if(c=As(c),c in Vt)return;Vt[c]=!0;const m=c.endsWith(".css"),h=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${h}`))return;const y=document.createElement("link");if(y.rel=m?"stylesheet":qs,m||(y.as="script"),y.crossOrigin="",y.href=c,d&&y.setAttribute("nonce",d),document.head.appendChild(y),m)return new Promise((w,I)=>{y.addEventListener("load",w),y.addEventListener("error",()=>I(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=i,window.dispatchEvent(d),!d.defaultPrevented)throw i}return s.then(i=>{for(const d of i||[])d.status==="rejected"&&r(d.reason);return t().catch(r)})};function Eo(a,t={}){typeof window>"u"||window.dispatchEvent(new CustomEvent("learn-spanish-message",{detail:{id:`${Date.now()}-${Math.random().toString(16).slice(2)}`,title:t.title||"Notice",message:a,tone:t.tone||"info",timeout:t.timeout||5200}}))}function Ts(){const[a,t]=p.useState([]);return p.useEffect(()=>{function o(n){const s=n.detail||{};s.message&&(t(r=>[s,...r].slice(0,3)),s.timeout!==1/0&&window.setTimeout(()=>{t(r=>r.filter(i=>i.id!==s.id))},s.timeout||5200))}return window.addEventListener("learn-spanish-message",o),()=>window.removeEventListener("learn-spanish-message",o)},[]),a.length?e.jsx("div",{className:"app-message-stack","aria-live":"polite","aria-atomic":"false",children:a.map(o=>e.jsxs("div",{className:`app-message app-message-${o.tone||"info"}`,children:[e.jsxs("div",{children:[e.jsx("span",{className:"app-message-title",children:o.title}),e.jsx("p",{children:o.message})]}),e.jsx("button",{type:"button",className:"app-message-close",onClick:()=>t(n=>n.filter(s=>s.id!==o.id)),"aria-label":"Dismiss message",children:e.jsx(Je,{size:14})})]},o.id))}):null}function Ls({insights:a=[],onAction:t}){return a.length?e.jsxs("section",{className:"teacher-panel","aria-label":"Teacher recommendations",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(bt,{size:18}),"Teacher notes"]}),e.jsx("div",{className:"teacher-card-grid",children:a.map(o=>e.jsxs("button",{className:"teacher-card",onClick:()=>t?.(o.action),children:[e.jsx("span",{className:"teacher-card-title",children:o.title}),e.jsx("span",{className:"teacher-card-detail",children:o.detail}),e.jsxs("span",{className:"teacher-card-action",children:[o.actionLabel||"Open",e.jsx(Re,{size:14})]})]},o.key))})]}):null}const Ka="study-time-v1",kt=240;function Lo(a=new Date){return a.toISOString().slice(0,10)}function Ms(a){if(!a||typeof a!="object")return null;const t=String(a.id||"").trim();if(!t)return null;const o=Math.max(0,Math.floor(Number(a.seconds)||0));return o?{id:t,chapterId:String(a.chapterId||"unknown"),date:a.date||Lo(new Date(Number(a.startedAt)||Date.now())),seconds:o,startedAt:Number(a.startedAt)||Number(a.updatedAt)||Date.now(),updatedAt:Number(a.updatedAt)||Number(a.startedAt)||Date.now()}:null}function Ps(a={}){return(Array.isArray(a.sessions)?a.sessions:[]).map(Ms).filter(Boolean).sort((t,o)=>(o.updatedAt||0)-(t.updatedAt||0)).slice(0,kt)}function ua(a,t=()=>!0){return a.reduce((o,n)=>o+(t(n)?n.seconds:0),0)}function _s(a){const t={};for(const o of a)t[o.chapterId]=(t[o.chapterId]||0)+o.seconds;return t}function La(a={}){const t=Lo(),o=a.date===t?a.date:t,n=a.date===t?Math.max(0,Number(a.todaySeconds)||0):0,s=Ps(a);return{totalSeconds:Math.max(0,Number(a.totalSeconds)||0),todaySeconds:n,date:o,byChapter:a.byChapter&&typeof a.byChapter=="object"?a.byChapter:{},sessions:s,updatedAt:a.updatedAt||Date.now()}}function kn(a={},t={}){const o=La(a),n=La(t),s=new Map;for(const v of[...n.sessions,...o.sessions]){const N=s.get(v.id);(!N||(v.updatedAt||0)>=(N.updatedAt||0))&&s.set(v.id,v)}const r=[...s.values()].sort((v,N)=>(N.updatedAt||0)-(v.updatedAt||0)).slice(0,kt),i=ua(o.sessions),d=ua(n.sessions),g=ua(r),c=Lo(),m=ua(o.sessions,v=>v.date===c),h=ua(n.sessions,v=>v.date===c),y=ua(r,v=>v.date===c),w=_s(r),I={...w};for(const v of new Set([...Object.keys(n.byChapter||{}),...Object.keys(o.byChapter||{})])){const N=ua(o.sessions,A=>A.chapterId===v),q=ua(n.sessions,A=>A.chapterId===v),$=Math.max(0,(Number(o.byChapter?.[v])||0)-N),C=Math.max(0,(Number(n.byChapter?.[v])||0)-q);I[v]=Math.max($,C)+(w[v]||0)}const u=Math.max(Math.max(0,o.totalSeconds-i),Math.max(0,n.totalSeconds-d)),k=Math.max(Math.max(0,o.todaySeconds-m),Math.max(0,n.todaySeconds-h));return{totalSeconds:u+g,todaySeconds:k+y,date:c,byChapter:I,sessions:r,updatedAt:Math.max(Number(o.updatedAt)||0,Number(n.updatedAt)||0,Date.now())}}function Ds(a={},t,o,n=Date.now()){const s=La(a),r=Lo(new Date(n)),i=o||`${r}-${t||"lesson"}`,d=[...s.sessions],g=d.findIndex(c=>c.id===i);return g>=0?d[g]={...d[g],chapterId:t,date:r,seconds:d[g].seconds+1,updatedAt:n}:d.unshift({id:i,chapterId:t,date:r,seconds:1,startedAt:n,updatedAt:n}),{...s,totalSeconds:s.totalSeconds+1,todaySeconds:s.date===r?s.todaySeconds+1:1,date:r,byChapter:{...s.byChapter,[t]:(Number(s.byChapter?.[t])||0)+1},sessions:d.sort((c,m)=>(m.updatedAt||0)-(c.updatedAt||0)).slice(0,kt),updatedAt:n}}function ya(a=0){const t=Math.max(0,Math.floor(Number(a)||0)),o=Math.floor(t/3600),n=Math.floor(t%3600/60);return o>0?`${o}h ${String(n).padStart(2,"0")}m`:n>0?`${n}m`:`${t}s`}function vo({icon:a,label:t,value:o,detail:n}){return e.jsxs("div",{className:"teacher-metric",children:[e.jsx(a,{size:16}),e.jsx("span",{children:t}),e.jsx("strong",{children:o}),e.jsx("em",{children:n})]})}function Rs({totalLessons:a,visitedCount:t,savedWordsCount:o,levelFilter:n,palabrasSummary:s,lessonSummary:r,memoriaSummary:i,learnerProfile:d,reviewQueue:g,studyTime:c,dailyPlan:m,dailyProgress:h,teacherInsights:y,writingCount:w,sectionProgress:I,recommendations:u,onStart:k,onStartDaily:v,onDailyStep:N,onOpenMemoria:q,onOpenPalabras:$,onOpenVerb:C,onOpenReading:A,onOpenWriting:j,onSelectChapter:U,onTeacherAction:F}){const E=a?Math.round(t/a*100):0,K=m.find(M=>!M.complete)||m[0],O=y?.[0]||{title:"Begin today gently",detail:"Open the next lesson, read one page, then save one useful word in Memoria.",action:"daily",actionLabel:"Start"},B=r?.mastered||0,R=O.action||"daily";return e.jsxs("article",{className:"chapter-body home-dashboard",children:[e.jsxs("header",{className:"home-hero",children:[e.jsxs("div",{className:"home-kicker",children:[e.jsx(bt,{size:18}),"Daily Teacher Mode"]}),e.jsx("h1",{className:"home-title",children:"Lexiora"}),e.jsx("p",{className:"home-subtitle",children:"A calm Spanish study room: one lesson, one review queue, one clear next action."}),e.jsxs("div",{className:"home-actions",children:[e.jsxs("button",{className:"home-primary",onClick:v||k,children:["Start Daily Lesson",e.jsx(Re,{size:16})]}),e.jsxs("button",{className:"home-secondary",onClick:q,children:[e.jsx(wa,{size:15}),"Memoria"]})]})]}),e.jsxs("section",{className:"daily-teacher-panel","aria-label":"Daily teacher mode",children:[e.jsxs("div",{className:"daily-teacher-main",children:[e.jsxs("span",{className:"home-section-heading",children:[e.jsx(ws,{size:18}),"Teacher focus"]}),e.jsx("h2",{children:O.title}),e.jsx("p",{children:O.detail}),e.jsxs("div",{className:"daily-teacher-actions",children:[e.jsxs("button",{onClick:()=>F?.(R),children:[O.actionLabel||"Open",e.jsx(Re,{size:15})]}),K&&e.jsxs("button",{className:"secondary",onClick:()=>N(K.key),children:["Next: ",K.title]})]})]}),e.jsxs("div",{className:"daily-teacher-card",children:[e.jsxs("span",{children:[h.completed," / ",h.total]}),e.jsx("strong",{children:"Today"}),e.jsxs("em",{children:[h.streak," day streak"]})]})]}),e.jsxs("section",{className:"teacher-metrics","aria-label":"Today's study metrics",children:[e.jsx(vo,{icon:ao,label:"Today",value:ya(c.todaySeconds),detail:`${ya(c.totalSeconds)} total`}),e.jsx(vo,{icon:ks,label:"Mastery",value:B,detail:`${r.understood} understood`}),e.jsx(vo,{icon:wa,label:"Memoria",value:o,detail:`${i.due} due`}),e.jsx(vo,{icon:xt,label:"Writing",value:w,detail:`${d.writing?.needsPractice||0} to rewrite`})]}),e.jsx(Ls,{insights:y,onAction:F}),e.jsxs("section",{className:"home-stats","aria-label":"Study progress",children:[e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Progreso"}),e.jsxs("strong",{children:[E,"%"]}),e.jsxs("span",{children:[t," / ",a," lecciones"]})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Nivel"}),e.jsx("strong",{children:n==="ALL"?"Todo":n}),e.jsx("span",{children:"Filtro activo"})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Palabras due"}),e.jsx("strong",{children:s.due}),e.jsxs("span",{children:[s.mastered," dominadas"]})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Lecciones"}),e.jsx("strong",{children:r.understood}),e.jsxs("span",{children:[r.read," leidas"]})]})]}),e.jsxs("section",{className:"home-daily",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(ct,{size:18}),"Ruta diaria"]}),e.jsx("div",{className:"home-daily-grid",children:m.map(M=>e.jsxs("button",{className:`home-daily-step ${M.complete?"complete":""}`,onClick:()=>N(M.key),children:[e.jsx("span",{children:M.index}),e.jsx("strong",{children:M.title}),e.jsx("em",{children:M.detail}),e.jsx("small",{children:M.complete?"Done":"Open"})]},M.key))})]}),e.jsxs("section",{className:"home-review-queue",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(js,{size:18}),"Cola de repaso"]}),e.jsx("div",{className:"home-review-list",children:g.slice(0,8).map((M,V)=>e.jsxs("button",{onClick:()=>M.chapter?U(M.chapter):M.type==="writing"?j():q(),children:[e.jsx("span",{className:`review-type ${M.type}`,children:M.type}),e.jsx("strong",{children:M.title}),e.jsx("em",{children:M.detail})]},`${M.type}-${M.title}-${V}`))}),e.jsxs("div",{className:"home-review-summary",children:[d.vocabulary.due," vocabulary due - ",d.writing.needsPractice," writing rewrites - ",d.chapters.unvisited," lesson groups to open"]})]}),e.jsxs("section",{className:"home-progress-map",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(vt,{size:18}),"Mapa de progreso"]}),e.jsx("div",{className:"home-progress-list",children:I.map(M=>{const V=M.total?Math.round(M.visited/M.total*100):0;return e.jsxs("div",{className:"home-progress-row",children:[e.jsxs("div",{className:"home-progress-top",children:[e.jsx("span",{children:M.label}),e.jsxs("strong",{children:[M.visited," / ",M.total]})]}),e.jsx("div",{className:"home-progress-track",children:e.jsx("span",{style:{width:`${V}%`}})})]},M.id)})})]}),e.jsxs("section",{className:"home-path",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(ao,{size:18}),"Siguiente lectura"]}),e.jsx("div",{className:"home-recommendations",children:u.map((M,V)=>e.jsxs("button",{className:"home-rec",onClick:()=>U(M),children:[e.jsx("span",{className:"home-rec-index",children:String(V+1).padStart(2,"0")}),e.jsxs("span",{className:"home-rec-main",children:[e.jsx("span",{className:"home-rec-title",children:M.title}),e.jsxs("span",{className:"home-rec-meta",children:[M.sectionLabel," - ",M.level]})]}),e.jsx(Re,{size:16})]},M.id))})]})]})}function Gs({installReady:a,installMessage:t,onInstall:o,onDismiss:n}){return e.jsxs("div",{className:"install-banner",children:[e.jsxs("div",{className:"resume-banner-text",children:[e.jsx("span",{className:"resume-banner-label",children:"Install Lexiora"}),e.jsx("span",{className:"resume-banner-title",children:a?"Add the app to this device":"Add to Home Screen if your browser hides the icon"}),t&&e.jsx("span",{className:"install-banner-message",children:t})]}),e.jsxs("div",{className:"resume-banner-actions",children:[e.jsxs("button",{className:"resume-btn-primary install-btn-primary",onClick:o,children:[e.jsx(vn,{size:15}),"Install"]}),e.jsx("button",{className:"resume-btn-dismiss",onClick:n,"aria-label":"Dismiss install banner",children:e.jsx(Je,{size:15})})]})]})}let xa=null,Ht=!1,Ma={rate:.85,voiceURI:""};function jn(){return Math.max(.65,Math.min(1.25,Number(Ma.rate)||.85))}function Xa(a={}){Ma={...Ma,...a,rate:Math.max(.65,Math.min(1.25,Number(a.rate??Ma.rate)||.85))},xa=null}function Nn(){return typeof window>"u"||!window.speechSynthesis?[]:window.speechSynthesis.getVoices()||[]}function Wt(){return Nn().filter(a=>a.lang&&a.lang.toLowerCase().startsWith("es")||/spanish|espanol|espaÃ±ol/i.test(a.name||""))}function qa(){if(typeof window>"u"||!window.speechSynthesis)return null;if(xa)return xa;const a=Nn();if(a.length===0)return null;if(Ma.voiceURI){const n=a.find(s=>s.voiceURI===Ma.voiceURI);if(n)return xa=n,n}const t=["es-ES","es-MX","es-US","es-AR","es-CO","es-419","es"];for(const n of t){const s=a.find(r=>r.lang&&r.lang.toLowerCase().startsWith(n.toLowerCase()));if(s)return xa=s,s}const o=a.find(n=>/spanish|español/i.test(n.name||""));return o?(xa=o,o):null}typeof window<"u"&&window.speechSynthesis&&(window.speechSynthesis.addEventListener?.("voiceschanged",()=>{xa=null,qa()}),qa(),setTimeout(qa,250),setTimeout(qa,1e3));function jt(){if(!Ht&&!(typeof window>"u"||!window.speechSynthesis))try{const a=new SpeechSynthesisUtterance(" ");a.volume=0,a.rate=1,window.speechSynthesis.speak(a),Ht=!0}catch{}}function oo(){try{window.speechSynthesis?.cancel(),window.dispatchEvent?.(new CustomEvent("learn-spanish-audio-stop"))}catch{}}function zn(a,t={}){if(typeof window>"u"||!window.speechSynthesis||!a)return t.onerror&&t.onerror({error:"no-speechSynthesis"}),null;try{window.speechSynthesis.cancel();const o=new SpeechSynthesisUtterance(a),n=qa();n&&(o.voice=n),o.lang=n?.lang||"es-ES",o.rate=t.rate??jn(),o.pitch=t.pitch??1,o.volume=1,t.onend&&(o.onend=t.onend),t.onerror&&(o.onerror=i=>{console.warn("[speech] error:",i?.error||"unknown",{text:a.slice(0,30),voice:n?.name}),t.onerror(i)}),t.onboundary&&(o.onboundary=t.onboundary),t.onstart&&(o.onstart=t.onstart),window.speechSynthesis.speak(o);const s=setInterval(()=>{if(!window.speechSynthesis.speaking){clearInterval(s);return}window.speechSynthesis.pause(),window.speechSynthesis.resume()},14e3),r=o.onend;return o.onend=i=>{clearInterval(s),r&&r(i)},o}catch(o){return console.warn("[speech] threw:",o),t.onerror&&t.onerror({error:o.message}),null}}const Yt=/([\p{L}\p{N}]+)|([^\p{L}\p{N}]+)/gu;function Sn(a){const t=[],o=String(a||"");let n;for(Yt.lastIndex=0;(n=Yt.exec(o))!==null;)t.push({text:n[0],isWord:!!n[1],charStart:n.index});return t}function de({text:a}){const t=p.useMemo(()=>Sn(a),[a]);return e.jsx(e.Fragment,{children:t.map((o,n)=>o.isWord?e.jsx("span",{className:"dict-word-token","data-dict-word":o.text,children:o.text},n):e.jsx("span",{children:o.text},n))})}function no({text:a,paragraphClass:t="reading-paragraph",firstParagraph:o=!1}){const n=p.useMemo(()=>Sn(a),[a]),s=p.useMemo(()=>{const u=[];let k="",v=[],N=-1;function q(){v.length>0&&u.push({spokenText:k.trim(),words:v}),k="",v=[],N=-1}for(let $=0;$<n.length;$++){const C=n[$];if(!C.isWord&&v.length===0&&/^\s+$/.test(C.text))continue;const A=k.length;k+=C.text,C.isWord?(v.push({tokenIdx:$,text:C.text,charStart:A,charEnd:A+C.text.length,commaAfter:!1}),N=v.length-1):(/,/.test(C.text)&&N>=0&&(v[N].commaAfter=!0),/[.!?;:]/.test(C.text)&&q())}return q(),u},[n]),[r,i]=p.useState(-1),[d,g]=p.useState(!1),c=oe.useRef([]),m=oe.useRef([]),h=oe.useRef(!1),y=oe.useRef(110);function w(){m.current.forEach(clearTimeout),m.current=[]}function I(u){if(u.stopPropagation(),typeof window>"u"||!window.speechSynthesis){Eo("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(jt(),d){h.current=!0,oo(),w(),g(!1),i(-1);return}if(s.length===0)return;oo(),w(),h.current=!1,g(!0),y.current=110;let k=0;function v(){if(h.current)return;if(k>=s.length){g(!1),i(-1);return}const N=s[k];if(!N||N.words.length===0){k++,v();return}const q=new SpeechSynthesisUtterance(N.spokenText),$=qa();$&&(q.voice=$),q.lang=$?.lang||"es-ES",q.rate=jn(),q.pitch=1;let C=!1,A=!1,j=!1,U=!1,F=0;const E=30,K=200;function O(H){const b=Math.max(0,Number(H)||0);let D=N.words[0];for(const Q of N.words)if(Q.charStart<=b+1)D=Q;else break;return D}function B(){if(U||j||h.current)return;U=!0;let H=0;for(let b=0;b<N.words.length;b++){const D=N.words[b],X=setTimeout(()=>{!h.current&&!j&&i(D.tokenIdx)},H);m.current.push(X),H+=D.text.length*y.current+E,D.commaAfter&&(H+=K)}}q.onstart=()=>{if(C)return;C=!0,F=performance.now();const H=setTimeout(B,350);m.current.push(H)},q.onboundary=H=>{if(h.current||typeof H.charIndex!="number")return;const b=O(H.charIndex);b&&(j=!0,i(b.tokenIdx))};const R=setTimeout(()=>{!C&&!h.current&&(C=!0,F=performance.now(),B())},500);m.current.push(R);function M(){if(A||(A=!0,h.current))return;if(F>0){const b=performance.now()-F,D=N.words.reduce((Y,Se)=>Y+Se.text.length,0),Q=N.words.filter(Y=>Y.commaAfter).length,X=N.words.length*E+Q*K,J=Math.max(100,b-X);if(D>0){const Y=J/D;Y>=40&&Y<=300&&(y.current=Y*.6+y.current*.4)}}w(),k++;const H=setTimeout(v,30);m.current.push(H)}q.onend=M,q.onerror=M;const V=Math.max(5e3,N.spokenText.length*220),se=setTimeout(M,V);m.current.push(se),window.speechSynthesis.speak(q)}v()}return p.useEffect(()=>{function u(){h.current=!0,w(),g(!1),i(-1)}return window.addEventListener?.("learn-spanish-audio-stop",u),()=>{h.current=!0,w(),window.removeEventListener?.("learn-spanish-audio-stop",u),window.speechSynthesis?.cancel()}},[]),p.useEffect(()=>{if(r<0)return;const u=c.current[r];if(!u||typeof u.getBoundingClientRect!="function")return;const k=u.getBoundingClientRect(),v=window.innerHeight||document.documentElement.clientHeight;(k.bottom>v-100||k.top<80)&&u.scrollIntoView({behavior:"smooth",block:"center"})},[r]),typeof window<"u"&&!window.speechSynthesis?e.jsxs("p",{className:t,children:[e.jsx("button",{className:"speak-btn speak-btn-sm paragraph-speak",onClick:u=>{u.stopPropagation(),Eo("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"})},"aria-label":"Audio not supported",title:"Audio no disponible",children:e.jsx(pt,{size:12})}),e.jsx(de,{text:a})]}):e.jsxs("p",{className:`${t} karaoke-paragraph ${d?"is-playing":""}`,children:[e.jsx("button",{className:`speak-btn speak-btn-sm paragraph-speak ${d?"playing":""}`,onClick:I,onPointerDown:u=>u.stopPropagation(),"aria-label":d?"Stop":"Play audio with highlighting",title:d?"Detener":"Escuchar con resaltado",children:e.jsx(pt,{size:12})}),n.map((u,k)=>{if(!u.isWord)return e.jsx("span",{className:"kt-space",children:u.text},k);const v=k===r;return e.jsx("span",{ref:N=>c.current[k]=N,className:`kt-word ${v?"kt-active":""}`,"data-dict-word":u.text,children:u.text},k)})]})}function re({text:a,size:t="sm",className:o=""}){const[n,s]=p.useState(!1);p.useEffect(()=>{function i(){s(!1)}return window.addEventListener?.("learn-spanish-audio-stop",i),()=>window.removeEventListener?.("learn-spanish-audio-stop",i)},[]);function r(i){if(i.stopPropagation(),typeof window>"u"||!window.speechSynthesis){Eo("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(jt(),n){oo(),s(!1);return}oo(),s(!0),zn(a,{onend:()=>s(!1),onerror:d=>{s(!1),d?.error&&d.error!=="canceled"&&d.error!=="interrupted"&&Eo(`Error al leer: ${d.error}. Asegurate de tener una voz en espanol instalada.`,{title:"Audio necesita atencion",tone:"warning"})}})}return e.jsx("button",{className:`speak-btn speak-btn-${t} ${n?"playing":""} ${o}`,onClick:r,onPointerDown:i=>i.stopPropagation(),"aria-label":n?"Stop":"Play audio",title:n?"Detener":"Escuchar",children:e.jsx(pt,{size:t==="sm"?12:14})})}function Us({settings:a,onChange:t}){const[o,n]=p.useState(()=>Wt());p.useEffect(()=>{Xa(a)},[a]),p.useEffect(()=>{function r(){n(Wt())}if(r(),typeof window<"u"&&window.speechSynthesis){window.speechSynthesis.addEventListener?.("voiceschanged",r);const i=setTimeout(r,600);return()=>{clearTimeout(i),window.speechSynthesis.removeEventListener?.("voiceschanged",r)}}},[]);function s(r){const i={...a,...r};Xa(i),t?.(i)}return e.jsxs("div",{className:"audio-settings","aria-label":"Audio settings",children:[e.jsxs("div",{className:"audio-settings-label",children:[e.jsx(yn,{size:14}),"Audio"]}),e.jsxs("select",{className:"audio-rate-select",value:String(a.rate),onChange:r=>s({rate:Number(r.target.value)}),"aria-label":"Audio speed",children:[e.jsx("option",{value:"0.7",children:"0.70x"}),e.jsx("option",{value:"0.85",children:"0.85x"}),e.jsx("option",{value:"1",children:"1.00x"}),e.jsx("option",{value:"1.15",children:"1.15x"})]}),e.jsxs("select",{className:"audio-voice-select",value:a.voiceURI||"",onChange:r=>s({voiceURI:r.target.value}),"aria-label":"Spanish voice",children:[e.jsx("option",{value:"",children:"Voz espanola"}),o.map(r=>e.jsxs("option",{value:r.voiceURI,children:[r.name," (",r.lang,")"]},r.voiceURI))]})]})}function Ye({es:a,en:t,esClass:o="vu-ex-es",enClass:n="vu-ex-en"}){const s=(a||"").length,r=(t||"").length;return s<=18&&r<=18&&s+r<=36?e.jsxs("div",{className:`${o} inline-pair`,children:[e.jsx(re,{text:a}),e.jsx(de,{text:a})," ",e.jsxs("span",{className:`${n} inline-en`,children:["(",t,")"]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:o,children:[e.jsx(re,{text:a}),e.jsx(de,{text:a})]}),e.jsx("div",{className:n,children:t})]})}const $s=`
