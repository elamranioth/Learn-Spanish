import{r as f,j as e,R as X,c as vs}from"./react-iLQ0ojkV.js";import{X as ve,H as Po,V as Ua,S as qe,M as ys,C as ba,L as Ve,B as Mo,a as ma,b as ze,c as Ha,d as We,P as Go,e as ws,f as Ba,g as _e,h as ks,G as Do,i as js,j as Ns,Z as $a,k as zs,l as la,T as da,m as Wa,N as _a,R as Ya,n as oa}from"./icons-Dy2zl4ae.js";import{C as Ss}from"./canciones-LNuSxTu4.js";import{C as qs,a as Cs}from"./compound-tenses-wpuk3-pq.js";import{S as Es}from"./expressions-library-BlTZ80NV.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const r of i.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&n(r)}).observe(document,{childList:!0,subtree:!0});function o(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function n(t){if(t.ep)return;t.ep=!0;const i=o(t);fetch(t.href,i)}})();function Is(){typeof window>"u"||!("serviceWorker"in navigator)||window.addEventListener("load",()=>{const a="/Learn-Spanish/";navigator.serviceWorker.register(`${a}sw.js?v=${encodeURIComponent("2026-05-19T19:04:28.357Z")}`,{scope:a,updateViaCache:"none"}).then(o=>{function n(t){window.dispatchEvent(new CustomEvent("learn-spanish-update-ready",{detail:{worker:t}}))}o.waiting&&navigator.serviceWorker.controller&&n(o.waiting),o.addEventListener("updatefound",()=>{const t=o.installing;t&&t.addEventListener("statechange",()=>{t.state==="installed"&&navigator.serviceWorker.controller&&n(t)})}),o.update().catch(()=>{})}).catch(()=>{}),navigator.serviceWorker.addEventListener("controllerchange",()=>{window.__learnSpanishRefreshing||(window.__learnSpanishRefreshing=!0,window.location.reload())})})}const Ts="modulepreload",Ls=function(a){return"/Learn-Spanish/"+a},ko={},As=function(s,o,n){let t=Promise.resolve();if(o&&o.length>0){let h=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),l=r?.nonce||r?.getAttribute("nonce");t=h(o.map(c=>{if(c=Ls(c),c in ko)return;ko[c]=!0;const m=c.endsWith(".css"),u=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const v=document.createElement("link");if(v.rel=m?"stylesheet":Ts,m||(v.as="script"),v.crossOrigin="",v.href=c,l&&v.setAttribute("nonce",l),document.head.appendChild(v),m)return new Promise((p,g)=>{v.addEventListener("load",p),v.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function i(r){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=r,window.dispatchEvent(l),!l.defaultPrevented)throw r}return t.then(r=>{for(const l of r||[])l.status==="rejected"&&i(l.reason);return s().catch(i)})};function ua(a,s={}){typeof window>"u"||window.dispatchEvent(new CustomEvent("learn-spanish-message",{detail:{id:`${Date.now()}-${Math.random().toString(16).slice(2)}`,title:s.title||"Notice",message:a,tone:s.tone||"info",timeout:s.timeout||5200}}))}function Ps(){const[a,s]=f.useState([]);return f.useEffect(()=>{function o(n){const t=n.detail||{};t.message&&(s(i=>[t,...i].slice(0,3)),t.timeout!==1/0&&window.setTimeout(()=>{s(i=>i.filter(r=>r.id!==t.id))},t.timeout||5200))}return window.addEventListener("learn-spanish-message",o),()=>window.removeEventListener("learn-spanish-message",o)},[]),a.length?e.jsx("div",{className:"app-message-stack","aria-live":"polite","aria-atomic":"false",children:a.map(o=>e.jsxs("div",{className:`app-message app-message-${o.tone||"info"}`,children:[e.jsxs("div",{children:[e.jsx("span",{className:"app-message-title",children:o.title}),e.jsx("p",{children:o.message})]}),e.jsx("button",{type:"button",className:"app-message-close",onClick:()=>s(n=>n.filter(t=>t.id!==o.id)),"aria-label":"Dismiss message",children:e.jsx(ve,{size:14})})]},o.id))}):null}let Me=null,jo=!1,Fe={rate:.85,voiceURI:""};function Uo(){return Math.max(.65,Math.min(1.25,Number(Fe.rate)||.85))}function ea(a={}){Fe={...Fe,...a,rate:Math.max(.65,Math.min(1.25,Number(a.rate??Fe.rate)||.85))},Me=null}function Bo(){return typeof window>"u"||!window.speechSynthesis?[]:window.speechSynthesis.getVoices()||[]}function No(){return Bo().filter(a=>a.lang&&a.lang.toLowerCase().startsWith("es")||/spanish|espanol|espaÃ±ol/i.test(a.name||""))}function Re(){if(typeof window>"u"||!window.speechSynthesis)return null;if(Me)return Me;const a=Bo();if(a.length===0)return null;if(Fe.voiceURI){const n=a.find(t=>t.voiceURI===Fe.voiceURI);if(n)return Me=n,n}const s=["es-ES","es-MX","es-US","es-AR","es-CO","es-419","es"];for(const n of s){const t=a.find(i=>i.lang&&i.lang.toLowerCase().startsWith(n.toLowerCase()));if(t)return Me=t,t}const o=a.find(n=>/spanish|español/i.test(n.name||""));return o?(Me=o,o):null}typeof window<"u"&&window.speechSynthesis&&(window.speechSynthesis.addEventListener?.("voiceschanged",()=>{Me=null,Re()}),Re(),setTimeout(Re,250),setTimeout(Re,1e3));function Ka(){if(!jo&&!(typeof window>"u"||!window.speechSynthesis))try{const a=new SpeechSynthesisUtterance(" ");a.volume=0,a.rate=1,window.speechSynthesis.speak(a),jo=!0}catch{}}function aa(){try{window.speechSynthesis?.cancel(),window.dispatchEvent?.(new CustomEvent("learn-spanish-audio-stop"))}catch{}}function $o(a,s={}){if(typeof window>"u"||!window.speechSynthesis||!a)return s.onerror&&s.onerror({error:"no-speechSynthesis"}),null;try{window.speechSynthesis.cancel();const o=new SpeechSynthesisUtterance(a),n=Re();n&&(o.voice=n),o.lang=n?.lang||"es-ES",o.rate=s.rate??Uo(),o.pitch=s.pitch??1,o.volume=1,s.onend&&(o.onend=s.onend),s.onerror&&(o.onerror=r=>{console.warn("[speech] error:",r?.error||"unknown",{text:a.slice(0,30),voice:n?.name}),s.onerror(r)}),s.onboundary&&(o.onboundary=s.onboundary),s.onstart&&(o.onstart=s.onstart),window.speechSynthesis.speak(o);const t=setInterval(()=>{if(!window.speechSynthesis.speaking){clearInterval(t);return}window.speechSynthesis.pause(),window.speechSynthesis.resume()},14e3),i=o.onend;return o.onend=r=>{clearInterval(t),i&&i(r)},o}catch(o){return console.warn("[speech] threw:",o),s.onerror&&s.onerror({error:o.message}),null}}const zo=/([\p{L}\p{N}]+)|([^\p{L}\p{N}]+)/gu;function Ro(a){const s=[],o=String(a||"");let n;for(zo.lastIndex=0;(n=zo.exec(o))!==null;)s.push({text:n[0],isWord:!!n[1],charStart:n.index});return s}function Z({text:a}){const s=f.useMemo(()=>Ro(a),[a]);return e.jsx(e.Fragment,{children:s.map((o,n)=>o.isWord?e.jsx("span",{className:"dict-word-token","data-dict-word":o.text,children:o.text},n):e.jsx("span",{children:o.text},n))})}function sa({text:a,paragraphClass:s="reading-paragraph",firstParagraph:o=!1}){const n=f.useMemo(()=>Ro(a),[a]),t=f.useMemo(()=>{const b=[];let N="",y=[],q=-1;function S(){y.length>0&&b.push({spokenText:N.trim(),words:y}),N="",y=[],q=-1}for(let T=0;T<n.length;T++){const z=n[T];if(!z.isWord&&y.length===0&&/^\s+$/.test(z.text))continue;const L=N.length;N+=z.text,z.isWord?(y.push({tokenIdx:T,text:z.text,charStart:L,charEnd:L+z.text.length,commaAfter:!1}),q=y.length-1):(/,/.test(z.text)&&q>=0&&(y[q].commaAfter=!0),/[.!?;:]/.test(z.text)&&S())}return S(),b},[n]),[i,r]=f.useState(-1),[l,h]=f.useState(!1),c=X.useRef([]),m=X.useRef([]),u=X.useRef(!1),v=X.useRef(110);function p(){m.current.forEach(clearTimeout),m.current=[]}function g(b){if(b.stopPropagation(),typeof window>"u"||!window.speechSynthesis){ua("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(Ka(),l){u.current=!0,aa(),p(),h(!1),r(-1);return}if(t.length===0)return;aa(),p(),u.current=!1,h(!0),v.current=110;let N=0;function y(){if(u.current)return;if(N>=t.length){h(!1),r(-1);return}const q=t[N];if(!q||q.words.length===0){N++,y();return}const S=new SpeechSynthesisUtterance(q.spokenText),T=Re();T&&(S.voice=T),S.lang=T?.lang||"es-ES",S.rate=Uo(),S.pitch=1;let z=!1,L=!1,O=!1,D=!1,K=0;const k=30,G=200;function V(C){const E=Math.max(0,Number(C)||0);let I=q.words[0];for(const A of q.words)if(A.charStart<=E+1)I=A;else break;return I}function ee(){if(D||O||u.current)return;D=!0;let C=0;for(let E=0;E<q.words.length;E++){const I=q.words[E],B=setTimeout(()=>{!u.current&&!O&&r(I.tokenIdx)},C);m.current.push(B),C+=I.text.length*v.current+k,I.commaAfter&&(C+=G)}}S.onstart=()=>{if(z)return;z=!0,K=performance.now();const C=setTimeout(ee,350);m.current.push(C)},S.onboundary=C=>{if(u.current||typeof C.charIndex!="number")return;const E=V(C.charIndex);E&&(O=!0,r(E.tokenIdx))};const $=setTimeout(()=>{!z&&!u.current&&(z=!0,K=performance.now(),ee())},500);m.current.push($);function F(){if(L||(L=!0,u.current))return;if(K>0){const E=performance.now()-K,I=q.words.reduce((re,Ke)=>re+Ke.text.length,0),A=q.words.filter(re=>re.commaAfter).length,B=q.words.length*k+A*G,te=Math.max(100,E-B);if(I>0){const re=te/I;re>=40&&re<=300&&(v.current=re*.6+v.current*.4)}}p(),N++;const C=setTimeout(y,30);m.current.push(C)}S.onend=F,S.onerror=F;const _=Math.max(5e3,q.spokenText.length*220),x=setTimeout(F,_);m.current.push(x),window.speechSynthesis.speak(S)}y()}return f.useEffect(()=>{function b(){u.current=!0,p(),h(!1),r(-1)}return window.addEventListener?.("learn-spanish-audio-stop",b),()=>{u.current=!0,p(),window.removeEventListener?.("learn-spanish-audio-stop",b),window.speechSynthesis?.cancel()}},[]),f.useEffect(()=>{if(i<0)return;const b=c.current[i];if(!b||typeof b.getBoundingClientRect!="function")return;const N=b.getBoundingClientRect(),y=window.innerHeight||document.documentElement.clientHeight;(N.bottom>y-100||N.top<80)&&b.scrollIntoView({behavior:"smooth",block:"center"})},[i]),typeof window<"u"&&!window.speechSynthesis?e.jsxs("p",{className:s,children:[e.jsx("button",{className:"speak-btn speak-btn-sm paragraph-speak",onClick:b=>{b.stopPropagation(),ua("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"})},"aria-label":"Audio not supported",title:"Audio no disponible",children:e.jsx(Ua,{size:12})}),e.jsx(Z,{text:a})]}):e.jsxs("p",{className:`${s} karaoke-paragraph ${l?"is-playing":""}`,children:[e.jsx("button",{className:`speak-btn speak-btn-sm paragraph-speak ${l?"playing":""}`,onClick:g,onPointerDown:b=>b.stopPropagation(),"aria-label":l?"Stop":"Play audio with highlighting",title:l?"Detener":"Escuchar con resaltado",children:e.jsx(Ua,{size:12})}),n.map((b,N)=>{if(!b.isWord)return e.jsx("span",{className:"kt-space",children:b.text},N);const y=N===i;return e.jsx("span",{ref:q=>c.current[N]=q,className:`kt-word ${y?"kt-active":""}`,"data-dict-word":b.text,children:b.text},N)})]})}function Y({text:a,size:s="sm",className:o=""}){const[n,t]=f.useState(!1);f.useEffect(()=>{function r(){t(!1)}return window.addEventListener?.("learn-spanish-audio-stop",r),()=>window.removeEventListener?.("learn-spanish-audio-stop",r)},[]);function i(r){if(r.stopPropagation(),typeof window>"u"||!window.speechSynthesis){ua("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(Ka(),n){aa(),t(!1);return}aa(),t(!0),$o(a,{onend:()=>t(!1),onerror:l=>{t(!1),l?.error&&l.error!=="canceled"&&l.error!=="interrupted"&&ua(`Error al leer: ${l.error}. Asegurate de tener una voz en espanol instalada.`,{title:"Audio necesita atencion",tone:"warning"})}})}return e.jsx("button",{className:`speak-btn speak-btn-${s} ${n?"playing":""} ${o}`,onClick:i,onPointerDown:r=>r.stopPropagation(),"aria-label":n?"Stop":"Play audio",title:n?"Detener":"Escuchar",children:e.jsx(Ua,{size:s==="sm"?12:14})})}function Ms({settings:a,onChange:s}){const[o,n]=f.useState(()=>No());f.useEffect(()=>{ea(a)},[a]),f.useEffect(()=>{function i(){n(No())}if(i(),typeof window<"u"&&window.speechSynthesis){window.speechSynthesis.addEventListener?.("voiceschanged",i);const r=setTimeout(i,600);return()=>{clearTimeout(r),window.speechSynthesis.removeEventListener?.("voiceschanged",i)}}},[]);function t(i){const r={...a,...i};ea(r),s?.(r)}return e.jsxs("div",{className:"audio-settings","aria-label":"Audio settings",children:[e.jsxs("div",{className:"audio-settings-label",children:[e.jsx(Po,{size:14}),"Audio"]}),e.jsxs("select",{className:"audio-rate-select",value:String(a.rate),onChange:i=>t({rate:Number(i.target.value)}),"aria-label":"Audio speed",children:[e.jsx("option",{value:"0.7",children:"0.70x"}),e.jsx("option",{value:"0.85",children:"0.85x"}),e.jsx("option",{value:"1",children:"1.00x"}),e.jsx("option",{value:"1.15",children:"1.15x"})]}),e.jsxs("select",{className:"audio-voice-select",value:a.voiceURI||"",onChange:i=>t({voiceURI:i.target.value}),"aria-label":"Spanish voice",children:[e.jsx("option",{value:"",children:"Voz espanola"}),o.map(i=>e.jsxs("option",{value:i.voiceURI,children:[i.name," (",i.lang,")"]},i.voiceURI))]})]})}function Se({es:a,en:s,esClass:o="vu-ex-es",enClass:n="vu-ex-en"}){const t=(a||"").length,i=(s||"").length;return t<=18&&i<=18&&t+i<=36?e.jsxs("div",{className:`${o} inline-pair`,children:[e.jsx(Y,{text:a}),e.jsx(Z,{text:a})," ",e.jsxs("span",{className:`${n} inline-en`,children:["(",s,")"]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:o,children:[e.jsx(Y,{text:a}),e.jsx(Z,{text:a})]}),e.jsx("div",{className:n,children:s})]})}const Gs=`
