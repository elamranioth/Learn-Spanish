...
import{r as p,j as e,R as ee,c as gs}from"./react-iLQ0ojkV.js";import{X as Ze,G as mt,C as $e,B as xa,T as fs,a as Qa,b as bs,Z as rt,c as xs,d as un,D as hn,H as gn,V as it,S as ze,M as vs,L as Ea,e as fn,f as zo,g as ys,h as lt,i as Ta,j as ws,k as ks,l as js,m as go,n as fo,o as Eo,N as bn,R as ut,p as Za}from"./icons-Dix0EpQo.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function o(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=o(s);fetch(s.href,r)}})();function Ns(){typeof window>"u"||!("serviceWorker"in navigator)||window.addEventListener("load",()=>{const a="/Learn-Spanish/";navigator.serviceWorker.register(`${a}sw.js?v=${encodeURIComponent("2026-06-02T15:19:44.339Z")}`,{scope:a,updateViaCache:"none"}).then(o=>{function n(s){s?.postMessage?.({type:"SKIP_WAITING"}),window.dispatchEvent(new CustomEvent("learn-spanish-update-ready",{detail:{worker:s}}))}o.waiting&&navigator.serviceWorker.controller&&n(o.waiting),o.addEventListener("updatefound",()=>{const s=o.installing;s&&s.addEventListener("statechange",()=>{s.state==="installed"&&navigator.serviceWorker.controller&&n(s)})}),o.update().catch(()=>{})}).catch(()=>{}),navigator.serviceWorker.addEventListener("controllerchange",()=>{window.__learnSpanishRefreshing||(window.__learnSpanishRefreshing=!0,window.location.reload())})})}const zs="modulepreload",Ss=function(a){return"/Learn-Spanish/"+a},Rt={},Pe=function(t,o,n){let s=Promise.resolve();if(o&&o.length>0){let g=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),d=i?.nonce||i?.getAttribute("nonce");s=g(o.map(c=>{if(c=Ss(c),c in Rt)return;Rt[c]=!0;const m=c.endsWith(".css"),h=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${h}`))return;const v=document.createElement("link");if(v.rel=m?"stylesheet":zs,m||(v.as="script"),v.crossOrigin="",v.href=c,d&&v.setAttribute("nonce",d),document.head.appendChild(v),m)return new Promise((j,L)=>{v.addEventListener("load",j),v.addEventListener("error",()=>L(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=i,window.dispatchEvent(d),!d.defaultPrevented)throw i}return s.then(i=>{for(const d of i||[])d.status==="rejected"&&r(d.reason);return t().catch(r)})};function So(a,t={}){typeof window>"u"||window.dispatchEvent(new CustomEvent("learn-spanish-message",{detail:{id:`${Date.now()}-${Math.random().toString(16).slice(2)}`,title:t.title||"Notice",message:a,tone:t.tone||"info",timeout:t.timeout||5200}}))}function Is(){const[a,t]=p.useState([]);return p.useEffect(()=>{function o(n){const s=n.detail||{};s.message&&(t(r=>[s,...r].slice(0,3)),s.timeout!==1/0&&window.setTimeout(()=>{t(r=>r.filter(i=>i.id!==s.id))},s.timeout||5200))}return window.addEventListener("learn-spanish-message",o),()=>window.removeEventListener("learn-spanish-message",o)},[]),a.length?e.jsx("div",{className:"app-message-stack","aria-live":"polite","aria-atomic":"false",children:a.map(o=>e.jsxs("div",{className:`app-message app-message-${o.tone||"info"}`,children:[e.jsxs("div",{children:[e.jsx("span",{className:"app-message-title",children:o.title}),e.jsx("p",{children:o.message})]}),e.jsx("button",{type:"button",className:"app-message-close",onClick:()=>t(n=>n.filter(s=>s.id!==o.id)),"aria-label":"Dismiss message",children:e.jsx(Ze,{size:14})})]},o.id))}):null}function Cs({insights:a=[],onAction:t}){return a.length?e.jsxs("section",{className:"teacher-panel","aria-label":"Teacher recommendations",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(mt,{size:18}),"Teacher notes"]}),e.jsx("div",{className:"teacher-card-grid",children:a.map(o=>e.jsxs("button",{className:"teacher-card",onClick:()=>t?.(o.action),children:[e.jsx("span",{className:"teacher-card-title",children:o.title}),e.jsx("span",{className:"teacher-card-detail",children:o.detail}),e.jsxs("span",{className:"teacher-card-action",children:[o.actionLabel||"Open",e.jsx($e,{size:14})]})]},o.key))})]}):null}const Va="study-time-v1",ht=240;function qo(a=new Date){return a.toISOString().slice(0,10)}function Es(a){if(!a||typeof a!="object")return null;const t=String(a.id||"").trim();if(!t)return null;const o=Math.max(0,Math.floor(Number(a.seconds)||0));return o?{id:t,chapterId:String(a.chapterId||"unknown"),date:a.date||qo(new Date(Number(a.startedAt)||Date.now())),seconds:o,startedAt:Number(a.startedAt)||Number(a.updatedAt)||Date.now(),updatedAt:Number(a.updatedAt)||Number(a.startedAt)||Date.now()}:null}function qs(a={}){return(Array.isArray(a.sessions)?a.sessions:[]).map(Es).filter(Boolean).sort((t,o)=>(o.updatedAt||0)-(t.updatedAt||0)).slice(0,ht)}function la(a,t=()=>!0){return a.reduce((o,n)=>o+(t(n)?n.seconds:0),0)}function As(a){const t={};for(const o of a)t[o.chapterId]=(t[o.chapterId]||0)+o.seconds;return t}function qa(a={}){const t=qo(),o=a.date===t?a.date:t,n=a.date===t?Math.max(0,Number(a.todaySeconds)||0):0,s=qs(a);return{totalSeconds:Math.max(0,Number(a.totalSeconds)||0),todaySeconds:n,date:o,byChapter:a.byChapter&&typeof a.byChapter=="object"?a.byChapter:{},sessions:s,updatedAt:a.updatedAt||Date.now()}}function xn(a={},t={}){const o=qa(a),n=qa(t),s=new Map;for(const y of[...n.sessions,...o.sessions]){const z=s.get(y.id);(!z||(y.updatedAt||0)>=(z.updatedAt||0))&&s.set(y.id,y)}const r=[...s.values()].sort((y,z)=>(z.updatedAt||0)-(y.updatedAt||0)).slice(0,ht),i=la(o.sessions),d=la(n.sessions),g=la(r),c=qo(),m=la(o.sessions,y=>y.date===c),h=la(n.sessions,y=>y.date===c),v=la(r,y=>y.date===c),j=As(r),L={...j};for(const y of new Set([...Object.keys(n.byChapter||{}),...Object.keys(o.byChapter||{})])){const z=la(o.sessions,E=>E.chapterId===y),D=la(n.sessions,E=>E.chapterId===y),G=Math.max(0,(Number(o.byChapter?.[y])||0)-z),C=Math.max(0,(Number(n.byChapter?.[y])||0)-D);L[y]=Math.max(G,C)+(j[y]||0)}const u=Math.max(Math.max(0,o.totalSeconds-i),Math.max(0,n.totalSeconds-d)),w=Math.max(Math.max(0,o.todaySeconds-m),Math.max(0,n.todaySeconds-h));return{totalSeconds:u+g,todaySeconds:w+v,date:c,byChapter:L,sessions:r,updatedAt:Math.max(Number(o.updatedAt)||0,Number(n.updatedAt)||0,Date.now())}}function Ts(a={},t,o,n=Date.now()){const s=qa(a),r=qo(new Date(n)),i=o||`${r}-${t||"lesson"}`,d=[...s.sessions],g=d.findIndex(c=>c.id===i);return g>=0?d[g]={...d[g],chapterId:t,date:r,seconds:d[g].seconds+1,updatedAt:n}:d.unshift({id:i,chapterId:t,date:r,seconds:1,startedAt:n,updatedAt:n}),{...s,totalSeconds:s.totalSeconds+1,todaySeconds:s.date===r?s.todaySeconds+1:1,date:r,byChapter:{...s.byChapter,[t]:(Number(s.byChapter?.[t])||0)+1},sessions:d.sort((c,m)=>(m.updatedAt||0)-(c.updatedAt||0)).slice(0,ht),updatedAt:n}}function ba(a=0){const t=Math.max(0,Math.floor(Number(a)||0)),o=Math.floor(t/3600),n=Math.floor(t%3600/60);return o>0?`${o}h ${String(n).padStart(2,"0")}m`:n>0?`${n}m`:`${t}s`}function Jo({icon:a,label:t,value:o,detail:n}){return e.jsxs("div",{className:"teacher-metric",children:[e.jsx(a,{size:16}),e.jsx("span",{children:t}),e.jsx("strong",{children:o}),e.jsx("em",{children:n})]})}function Ls({totalLessons:a,visitedCount:t,savedWordsCount:o,levelFilter:n,palabrasSummary:s,lessonSummary:r,memoriaSummary:i,learnerProfile:d,reviewQueue:g,studyTime:c,dailyPlan:m,dailyProgress:h,teacherInsights:v,sectionProgress:j,recommendations:L,onStart:u,onStartDaily:w,onDailyStep:y,onOpenMemoria:z,onOpenPalabras:D,onOpenVerb:G,onOpenReading:C,onSelectChapter:E,onTeacherAction:k}){const _=a?Math.round(t/a*100):0,O=m.find(q=>!q.complete)||m[0],I=v?.[0]||{title:"Begin today gently",detail:"Open the next lesson, read one page, then save one useful word in Memoria.",action:"daily",actionLabel:"Start"},Y=r?.mastered||0,F=I.action||"daily";return e.jsxs("article",{className:"chapter-body home-dashboard",children:[e.jsxs("header",{className:"home-hero",children:[e.jsxs("div",{className:"home-kicker",children:[e.jsx(mt,{size:18}),"Daily Teacher Mode"]}),e.jsx("h1",{className:"home-title",children:"Lexiora"}),e.jsx("p",{className:"home-subtitle",children:"A calm Spanish study room: one lesson, one review queue, one clear next action."}),e.jsxs("div",{className:"home-actions",children:[e.jsxs("button",{className:"home-primary",onClick:w||u,children:["Start Daily Lesson",e.jsx($e,{size:16})]}),e.jsxs("button",{className:"home-secondary",onClick:z,children:[e.jsx(xa,{size:15}),"Memoria"]})]})]}),e.jsxs("section",{className:"daily-teacher-panel","aria-label":"Daily teacher mode",children:[e.jsxs("div",{className:"daily-teacher-main",children:[e.jsxs("span",{className:"home-section-heading",children:[e.jsx(fs,{size:18}),"Teacher focus"]}),e.jsx("h2",{children:I.title}),e.jsx("p",{children:I.detail}),e.jsxs("div",{className:"daily-teacher-actions",children:[e.jsxs("button",{onClick:()=>k?.(F),children:[I.actionLabel||"Open",e.jsx($e,{size:15})]}),O&&e.jsxs("button",{className:"secondary",onClick:()=>y(O.key),children:["Next: ",O.title]})]})]}),e.jsxs("div",{className:"daily-teacher-card",children:[e.jsxs("span",{children:[h.completed," / ",h.total]}),e.jsx("strong",{children:"Today"}),e.jsxs("em",{children:[h.streak," day streak"]})]})]}),e.jsxs("section",{className:"teacher-metrics","aria-label":"Today's study metrics",children:[e.jsx(Jo,{icon:Qa,label:"Today",value:ba(c.todaySeconds),detail:`${ba(c.totalSeconds)} total`}),e.jsx(Jo,{icon:bs,label:"Mastery",value:Y,detail:`${r.understood} understood`}),e.jsx(Jo,{icon:xa,label:"Memoria",value:o,detail:`${i.due} due`})]}),e.jsx(Cs,{insights:v,onAction:k}),e.jsxs("section",{className:"home-stats","aria-label":"Study progress",children:[e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Progreso"}),e.jsxs("strong",{children:[_,"%"]}),e.jsxs("span",{children:[t," / ",a," lecciones"]})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Nivel"}),e.jsx("strong",{children:n==="ALL"?"Todo":n}),e.jsx("span",{children:"Filtro activo"})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Palabras due"}),e.jsx("strong",{children:s.due}),e.jsxs("span",{children:[s.mastered," dominadas"]})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Lecciones"}),e.jsx("strong",{children:r.understood}),e.jsxs("span",{children:[r.read," leidas"]})]})]}),e.jsxs("section",{className:"home-daily",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(rt,{size:18}),"Ruta diaria"]}),e.jsx("div",{className:"home-daily-grid",children:m.map(q=>e.jsxs("button",{className:`home-daily-step ${q.complete?"complete":""}`,onClick:()=>y(q.key),children:[e.jsx("span",{children:q.index}),e.jsx("strong",{children:q.title}),e.jsx("em",{children:q.detail}),e.jsx("small",{children:q.complete?"Done":"Open"})]},q.key))})]}),e.jsxs("section",{className:"home-review-queue",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(xs,{size:18}),"Cola de repaso"]}),e.jsx("div",{className:"home-review-list",children:g.slice(0,8).map((q,U)=>e.jsxs("button",{onClick:()=>q.chapter?E(q.chapter):z(),children:[e.jsx("span",{className:`review-type ${q.type}`,children:q.type}),e.jsx("strong",{children:q.title}),e.jsx("em",{children:q.detail})]},`${q.type}-${q.title}-${U}`))}),e.jsxs("div",{className:"home-review-summary",children:[d.vocabulary.due," vocabulary due - ",d.chapters.unvisited," lesson groups to open"]})]}),e.jsxs("section",{className:"home-progress-map",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(un,{size:18}),"Mapa de progreso"]}),e.jsx("div",{className:"home-progress-list",children:j.map(q=>{const U=q.total?Math.round(q.visited/q.total*100):0;return e.jsxs("div",{className:"home-progress-row",children:[e.jsxs("div",{className:"home-progress-top",children:[e.jsx("span",{children:q.label}),e.jsxs("strong",{children:[q.visited," / ",q.total]})]}),e.jsx("div",{className:"home-progress-track",children:e.jsx("span",{style:{width:`${U}%`}})})]},q.id)})})]}),e.jsxs("section",{className:"home-path",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(Qa,{size:18}),"Siguiente lectura"]}),e.jsx("div",{className:"home-recommendations",children:L.map((q,U)=>e.jsxs("button",{className:"home-rec",onClick:()=>E(q),children:[e.jsx("span",{className:"home-rec-index",children:String(U+1).padStart(2,"0")}),e.jsxs("span",{className:"home-rec-main",children:[e.jsx("span",{className:"home-rec-title",children:q.title}),e.jsxs("span",{className:"home-rec-meta",children:[q.sectionLabel," - ",q.level]})]}),e.jsx($e,{size:16})]},q.id))})]})]})}function Ms({installReady:a,installMessage:t,onInstall:o,onDismiss:n}){return e.jsxs("div",{className:"install-banner",children:[e.jsxs("div",{className:"resume-banner-text",children:[e.jsx("span",{className:"resume-banner-label",children:"Install Lexiora"}),e.jsx("span",{className:"resume-banner-title",children:a?"Add the app to this device":"Add to Home Screen if your browser hides the icon"}),t&&e.jsx("span",{className:"install-banner-message",children:t})]}),e.jsxs("div",{className:"resume-banner-actions",children:[e.jsxs("button",{className:"resume-btn-primary install-btn-primary",onClick:o,children:[e.jsx(hn,{size:15}),"Install"]}),e.jsx("button",{className:"resume-btn-dismiss",onClick:n,"aria-label":"Dismiss install banner",children:e.jsx(Ze,{size:15})})]})]})}let ga=null,Gt=!1,Aa={rate:.85,voiceURI:""};function vn(){return Math.max(.65,Math.min(1.25,Number(Aa.rate)||.85))}function Ya(a={}){Aa={...Aa,...a,rate:Math.max(.65,Math.min(1.25,Number(a.rate??Aa.rate)||.85))},ga=null}function yn(){return typeof window>"u"||!window.speechSynthesis?[]:window.speechSynthesis.getVoices()||[]}function Ut(){return yn().filter(a=>a.lang&&a.lang.toLowerCase().startsWith("es")||/spanish|espanol|espaÃ±ol/i.test(a.name||""))}function Ia(){if(typeof window>"u"||!window.speechSynthesis)return null;if(ga)return ga;const a=yn();if(a.length===0)return null;if(Aa.voiceURI){const n=a.find(s=>s.voiceURI===Aa.voiceURI);if(n)return ga=n,n}const t=["es-ES","es-MX","es-US","es-AR","es-CO","es-419","es"];for(const n of t){const s=a.find(r=>r.lang&&r.lang.toLowerCase().startsWith(n.toLowerCase()));if(s)return ga=s,s}const o=a.find(n=>/spanish|español/i.test(n.name||""));return o?(ga=o,o):null}typeof window<"u"&&window.speechSynthesis&&(window.speechSynthesis.addEventListener?.("voiceschanged",()=>{ga=null,Ia()}),Ia(),setTimeout(Ia,250),setTimeout(Ia,1e3));function gt(){if(!Gt&&!(typeof window>"u"||!window.speechSynthesis))try{const a=new SpeechSynthesisUtterance(" ");a.volume=0,a.rate=1,window.speechSynthesis.speak(a),Gt=!0}catch{}}function Xa(){try{window.speechSynthesis?.cancel(),window.dispatchEvent?.(new CustomEvent("learn-spanish-audio-stop"))}catch{}}function wn(a,t={}){if(typeof window>"u"||!window.speechSynthesis||!a)return t.onerror&&t.onerror({error:"no-speechSynthesis"}),null;try{window.speechSynthesis.cancel();const o=new SpeechSynthesisUtterance(a),n=Ia();n&&(o.voice=n),o.lang=n?.lang||"es-ES",o.rate=t.rate??vn(),o.pitch=t.pitch??1,o.volume=1,t.onend&&(o.onend=t.onend),t.onerror&&(o.onerror=i=>{console.warn("[speech] error:",i?.error||"unknown",{text:a.slice(0,30),voice:n?.name}),t.onerror(i)}),t.onboundary&&(o.onboundary=t.onboundary),t.onstart&&(o.onstart=t.onstart),window.speechSynthesis.speak(o);const s=setInterval(()=>{if(!window.speechSynthesis.speaking){clearInterval(s);return}window.speechSynthesis.pause(),window.speechSynthesis.resume()},14e3),r=o.onend;return o.onend=i=>{clearInterval(s),r&&r(i)},o}catch(o){return console.warn("[speech] threw:",o),t.onerror&&t.onerror({error:o.message}),null}}const $t=/([\p{L}\p{N}]+)|([^\p{L}\p{N}]+)/gu;function kn(a){const t=[],o=String(a||"");let n;for($t.lastIndex=0;(n=$t.exec(o))!==null;)t.push({text:n[0],isWord:!!n[1],charStart:n.index});return t}function ce({text:a}){const t=p.useMemo(()=>kn(a),[a]);return e.jsx(e.Fragment,{children:t.map((o,n)=>o.isWord?e.jsx("span",{className:"dict-word-token","data-dict-word":o.text,children:o.text},n):e.jsx("span",{children:o.text},n))})}function eo({text:a,paragraphClass:t="reading-paragraph",firstParagraph:o=!1}){const n=p.useMemo(()=>kn(a),[a]),s=p.useMemo(()=>{const u=[];let w="",y=[],z=-1;function D(){y.length>0&&u.push({spokenText:w.trim(),words:y}),w="",y=[],z=-1}for(let G=0;G<n.length;G++){const C=n[G];if(!C.isWord&&y.length===0&&/^\s+$/.test(C.text))continue;const E=w.length;w+=C.text,C.isWord?(y.push({tokenIdx:G,text:C.text,charStart:E,charEnd:E+C.text.length,commaAfter:!1}),z=y.length-1):(/,/.test(C.text)&&z>=0&&(y[z].commaAfter=!0),/[.!?;:]/.test(C.text)&&D())}return D(),u},[n]),[r,i]=p.useState(-1),[d,g]=p.useState(!1),c=ee.useRef([]),m=ee.useRef([]),h=ee.useRef(!1),v=ee.useRef(110);function j(){m.current.forEach(clearTimeout),m.current=[]}function L(u){if(u.stopPropagation(),typeof window>"u"||!window.speechSynthesis){So("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(gt(),d){h.current=!0,Xa(),j(),g(!1),i(-1);return}if(s.length===0)return;Xa(),j(),h.current=!1,g(!0),v.current=110;let w=0;function y(){if(h.current)return;if(w>=s.length){g(!1),i(-1);return}const z=s[w];if(!z||z.words.length===0){w++,y();return}const D=new SpeechSynthesisUtterance(z.spokenText),G=Ia();G&&(D.voice=G),D.lang=G?.lang||"es-ES",D.rate=vn(),D.pitch=1;let C=!1,E=!1,k=!1,_=!1,O=0;const I=30,Y=200;function F(V){const x=Math.max(0,Number(V)||0);let M=z.words[0];for(const W of z.words)if(W.charStart<=x+1)M=W;else break;return M}function q(){if(_||k||h.current)return;_=!0;let V=0;for(let x=0;x<z.words.length;x++){const M=z.words[x],$=setTimeout(()=>{!h.current&&!k&&i(M.tokenIdx)},V);m.current.push($),V+=M.text.length*v.current+I,M.commaAfter&&(V+=Y)}}D.onstart=()=>{if(C)return;C=!0,O=performance.now();const V=setTimeout(q,350);m.current.push(V)},D.onboundary=V=>{if(h.current||typeof V.charIndex!="number")return;const x=F(V.charIndex);x&&(k=!0,i(x.tokenIdx))};const U=setTimeout(()=>{!C&&!h.current&&(C=!0,O=performance.now(),q())},500);m.current.push(U);function ae(){if(E||(E=!0,h.current))return;if(O>0){const x=performance.now()-O,M=z.words.reduce((ne,de)=>ne+de.text.length,0),W=z.words.filter(ne=>ne.commaAfter).length,$=z.words.length*I+W*Y,K=Math.max(100,x-$);if(M>0){const ne=K/M;ne>=40&&ne<=300&&(v.current=ne*.6+v.current*.4)}}j(),w++;const V=setTimeout(y,30);m.current.push(V)}D.onend=ae,D.onerror=ae;const H=Math.max(5e3,z.spokenText.length*220),te=setTimeout(ae,H);m.current.push(te),window.speechSynthesis.speak(D)}y()}return p.useEffect(()=>{function u(){h.current=!0,j(),g(!1),i(-1)}return window.addEventListener?.("learn-spanish-audio-stop",u),()=>{h.current=!0,j(),window.removeEventListener?.("learn-spanish-audio-stop",u),window.speechSynthesis?.cancel()}},[]),p.useEffect(()=>{if(r<0)return;const u=c.current[r];if(!u||typeof u.getBoundingClientRect!="function")return;const w=u.getBoundingClientRect(),y=window.innerHeight||document.documentElement.clientHeight;(w.bottom>y-100||w.top<80)&&u.scrollIntoView({behavior:"smooth",block:"center"})},[r]),typeof window<"u"&&!window.speechSynthesis?e.jsxs("p",{className:t,children:[e.jsx("button",{className:"speak-btn speak-btn-sm paragraph-speak",onClick:u=>{u.stopPropagation(),So("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"})},"aria-label":"Audio not supported",title:"Audio no disponible",children:e.jsx(it,{size:12})}),e.jsx(ce,{text:a})]}):e.jsxs("p",{className:`${t} karaoke-paragraph ${d?"is-playing":""}`,children:[e.jsx("button",{className:`speak-btn speak-btn-sm paragraph-speak ${d?"playing":""}`,onClick:L,onPointerDown:u=>u.stopPropagation(),"aria-label":d?"Stop":"Play audio with highlighting",title:d?"Detener":"Escuchar con resaltado",children:e.jsx(it,{size:12})}),n.map((u,w)=>{if(!u.isWord)return e.jsx("span",{className:"kt-space",children:u.text},w);const y=w===r;return e.jsx("span",{ref:z=>c.current[w]=z,className:`kt-word ${y?"kt-active":""}`,"data-dict-word":u.text,children:u.text},w)})]})}function le({text:a,size:t="sm",className:o=""}){const[n,s]=p.useState(!1);p.useEffect(()=>{function i(){s(!1)}return window.addEventListener?.("learn-spanish-audio-stop",i),()=>window.removeEventListener?.("learn-spanish-audio-stop",i)},[]);function r(i){if(i.stopPropagation(),typeof window>"u"||!window.speechSynthesis){So("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(gt(),n){Xa(),s(!1);return}Xa(),s(!0),wn(a,{onend:()=>s(!1),onerror:d=>{s(!1),d?.error&&d.error!=="canceled"&&d.error!=="interrupted"&&So(`Error al leer: ${d.error}. Asegurate de tener una voz en espanol instalada.`,{title:"Audio necesita atencion",tone:"warning"})}})}return e.jsx("button",{className:`speak-btn speak-btn-${t} ${n?"playing":""} ${o}`,onClick:r,onPointerDown:i=>i.stopPropagation(),"aria-label":n?"Stop":"Play audio",title:n?"Detener":"Escuchar",children:e.jsx(it,{size:t==="sm"?12:14})})}function Ps({settings:a,onChange:t}){const[o,n]=p.useState(()=>Ut());p.useEffect(()=>{Ya(a)},[a]),p.useEffect(()=>{function r(){n(Ut())}if(r(),typeof window<"u"&&window.speechSynthesis){window.speechSynthesis.addEventListener?.("voiceschanged",r);const i=setTimeout(r,600);return()=>{clearTimeout(i),window.speechSynthesis.removeEventListener?.("voiceschanged",r)}}},[]);function s(r){const i={...a,...r};Ya(i),t?.(i)}return e.jsxs("div",{className:"audio-settings","aria-label":"Audio settings",children:[e.jsxs("div",{className:"audio-settings-label",children:[e.jsx(gn,{size:14}),"Audio"]}),e.jsxs("select",{className:"audio-rate-select",value:String(a.rate),onChange:r=>s({rate:Number(r.target.value)}),"aria-label":"Audio speed",children:[e.jsx("option",{value:"0.7",children:"0.70x"}),e.jsx("option",{value:"0.85",children:"0.85x"}),e.jsx("option",{value:"1",children:"1.00x"}),e.jsx("option",{value:"1.15",children:"1.15x"})]}),e.jsxs("select",{className:"audio-voice-select",value:a.voiceURI||"",onChange:r=>s({voiceURI:r.target.value}),"aria-label":"Spanish voice",children:[e.jsx("option",{value:"",children:"Voz espanola"}),o.map(r=>e.jsxs("option",{value:r.voiceURI,children:[r.name," (",r.lang,")"]},r.voiceURI))]})]})}function Qe({es:a,en:t,esClass:o="vu-ex-es",enClass:n="vu-ex-en"}){const s=(a||"").length,r=(t||"").length;return s<=18&&r<=18&&s+r<=36?e.jsxs("div",{className:`${o} inline-pair`,children:[e.jsx(le,{text:a}),e.jsx(ce,{text:a})," ",e.jsxs("span",{className:`${n} inline-en`,children:["(",t,")"]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:o,children:[e.jsx(le,{text:a}),e.jsx(ce,{text:a})]}),e.jsx("div",{className:n,children:t})]})}const _s=`
