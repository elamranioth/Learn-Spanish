import{r as f,j as e,R as Z,c as Es}from"./react-iLQ0ojkV.js";import{X as we,H as Ho,V as Ya,S as Te,M as Is,C as za,L as Ye,B as Fo,a as va,b as eo,c as Ee,d as Qe,P as Wo,e as Ts,f as Ka,g as Xe,h as Ls,G as _o,i as As,j as Ms,Z as ya,k as Ps,l as ga,T as fa,m as ao,N as oo,R as so,n as ia}from"./icons-BZQlq4An.js";import{C as Ds}from"./canciones-LNuSxTu4.js";import{C as Gs,a as Us}from"./compound-tenses-wpuk3-pq.js";import{T as Bs}from"./tiempos-verbales-8hKY352g.js";import{S as $s}from"./expressions-library-BlTZ80NV.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function o(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(t){if(t.ep)return;t.ep=!0;const r=o(t);fetch(t.href,r)}})();function Rs(){typeof window>"u"||!("serviceWorker"in navigator)||window.addEventListener("load",()=>{const a="/Learn-Spanish/";navigator.serviceWorker.register(`${a}sw.js?v=${encodeURIComponent("2026-05-20T18:08:45.378Z")}`,{scope:a,updateViaCache:"none"}).then(o=>{function n(t){window.dispatchEvent(new CustomEvent("learn-spanish-update-ready",{detail:{worker:t}}))}o.waiting&&navigator.serviceWorker.controller&&n(o.waiting),o.addEventListener("updatefound",()=>{const t=o.installing;t&&t.addEventListener("statechange",()=>{t.state==="installed"&&navigator.serviceWorker.controller&&n(t)})}),o.update().catch(()=>{})}).catch(()=>{}),navigator.serviceWorker.addEventListener("controllerchange",()=>{window.__learnSpanishRefreshing||(window.__learnSpanishRefreshing=!0,window.location.reload())})})}const Os="modulepreload",Vs=function(a){return"/Learn-Spanish/"+a},Lo={},Hs=function(s,o,n){let t=Promise.resolve();if(o&&o.length>0){let h=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");t=h(o.map(c=>{if(c=Vs(c),c in Lo)return;Lo[c]=!0;const m=c.endsWith(".css"),u=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const v=document.createElement("link");if(v.rel=m?"stylesheet":Os,m||(v.as="script"),v.crossOrigin="",v.href=c,l&&v.setAttribute("nonce",l),document.head.appendChild(v),m)return new Promise((p,g)=>{v.addEventListener("load",p),v.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return t.then(i=>{for(const l of i||[])l.status==="rejected"&&r(l.reason);return s().catch(r)})};function wa(a,s={}){typeof window>"u"||window.dispatchEvent(new CustomEvent("learn-spanish-message",{detail:{id:`${Date.now()}-${Math.random().toString(16).slice(2)}`,title:s.title||"Notice",message:a,tone:s.tone||"info",timeout:s.timeout||5200}}))}function Fs(){const[a,s]=f.useState([]);return f.useEffect(()=>{function o(n){const t=n.detail||{};t.message&&(s(r=>[t,...r].slice(0,3)),t.timeout!==1/0&&window.setTimeout(()=>{s(r=>r.filter(i=>i.id!==t.id))},t.timeout||5200))}return window.addEventListener("learn-spanish-message",o),()=>window.removeEventListener("learn-spanish-message",o)},[]),a.length?e.jsx("div",{className:"app-message-stack","aria-live":"polite","aria-atomic":"false",children:a.map(o=>e.jsxs("div",{className:`app-message app-message-${o.tone||"info"}`,children:[e.jsxs("div",{children:[e.jsx("span",{className:"app-message-title",children:o.title}),e.jsx("p",{children:o.message})]}),e.jsx("button",{type:"button",className:"app-message-close",onClick:()=>s(n=>n.filter(t=>t.id!==o.id)),"aria-label":"Dismiss message",children:e.jsx(we,{size:14})})]},o.id))}):null}let Be=null,Ao=!1,Ke={rate:.85,voiceURI:""};function Yo(){return Math.max(.65,Math.min(1.25,Number(Ke.rate)||.85))}function ta(a={}){Ke={...Ke,...a,rate:Math.max(.65,Math.min(1.25,Number(a.rate??Ke.rate)||.85))},Be=null}function Ko(){return typeof window>"u"||!window.speechSynthesis?[]:window.speechSynthesis.getVoices()||[]}function Mo(){return Ko().filter(a=>a.lang&&a.lang.toLowerCase().startsWith("es")||/spanish|espanol|espaÃ±ol/i.test(a.name||""))}function We(){if(typeof window>"u"||!window.speechSynthesis)return null;if(Be)return Be;const a=Ko();if(a.length===0)return null;if(Ke.voiceURI){const n=a.find(t=>t.voiceURI===Ke.voiceURI);if(n)return Be=n,n}const s=["es-ES","es-MX","es-US","es-AR","es-CO","es-419","es"];for(const n of s){const t=a.find(r=>r.lang&&r.lang.toLowerCase().startsWith(n.toLowerCase()));if(t)return Be=t,t}const o=a.find(n=>/spanish|español/i.test(n.name||""));return o?(Be=o,o):null}typeof window<"u"&&window.speechSynthesis&&(window.speechSynthesis.addEventListener?.("voiceschanged",()=>{Be=null,We()}),We(),setTimeout(We,250),setTimeout(We,1e3));function no(){if(!Ao&&!(typeof window>"u"||!window.speechSynthesis))try{const a=new SpeechSynthesisUtterance(" ");a.volume=0,a.rate=1,window.speechSynthesis.speak(a),Ao=!0}catch{}}function ra(){try{window.speechSynthesis?.cancel(),window.dispatchEvent?.(new CustomEvent("learn-spanish-audio-stop"))}catch{}}function Jo(a,s={}){if(typeof window>"u"||!window.speechSynthesis||!a)return s.onerror&&s.onerror({error:"no-speechSynthesis"}),null;try{window.speechSynthesis.cancel();const o=new SpeechSynthesisUtterance(a),n=We();n&&(o.voice=n),o.lang=n?.lang||"es-ES",o.rate=s.rate??Yo(),o.pitch=s.pitch??1,o.volume=1,s.onend&&(o.onend=s.onend),s.onerror&&(o.onerror=i=>{console.warn("[speech] error:",i?.error||"unknown",{text:a.slice(0,30),voice:n?.name}),s.onerror(i)}),s.onboundary&&(o.onboundary=s.onboundary),s.onstart&&(o.onstart=s.onstart),window.speechSynthesis.speak(o);const t=setInterval(()=>{if(!window.speechSynthesis.speaking){clearInterval(t);return}window.speechSynthesis.pause(),window.speechSynthesis.resume()},14e3),r=o.onend;return o.onend=i=>{clearInterval(t),r&&r(i)},o}catch(o){return console.warn("[speech] threw:",o),s.onerror&&s.onerror({error:o.message}),null}}const Po=/([\p{L}\p{N}]+)|([^\p{L}\p{N}]+)/gu;function Qo(a){const s=[],o=String(a||"");let n;for(Po.lastIndex=0;(n=Po.exec(o))!==null;)s.push({text:n[0],isWord:!!n[1],charStart:n.index});return s}function K({text:a}){const s=f.useMemo(()=>Qo(a),[a]);return e.jsx(e.Fragment,{children:s.map((o,n)=>o.isWord?e.jsx("span",{className:"dict-word-token","data-dict-word":o.text,children:o.text},n):e.jsx("span",{children:o.text},n))})}function la({text:a,paragraphClass:s="reading-paragraph",firstParagraph:o=!1}){const n=f.useMemo(()=>Qo(a),[a]),t=f.useMemo(()=>{const x=[];let N="",w=[],S=-1;function q(){w.length>0&&x.push({spokenText:N.trim(),words:w}),N="",w=[],S=-1}for(let M=0;M<n.length;M++){const C=n[M];if(!C.isWord&&w.length===0&&/^\s+$/.test(C.text))continue;const D=N.length;N+=C.text,C.isWord?(w.push({tokenIdx:M,text:C.text,charStart:D,charEnd:D+C.text.length,commaAfter:!1}),S=w.length-1):(/,/.test(C.text)&&S>=0&&(w[S].commaAfter=!0),/[.!?;:]/.test(C.text)&&q())}return q(),x},[n]),[r,i]=f.useState(-1),[l,h]=f.useState(!1),c=Z.useRef([]),m=Z.useRef([]),u=Z.useRef(!1),v=Z.useRef(110);function p(){m.current.forEach(clearTimeout),m.current=[]}function g(x){if(x.stopPropagation(),typeof window>"u"||!window.speechSynthesis){wa("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(no(),l){u.current=!0,ra(),p(),h(!1),i(-1);return}if(t.length===0)return;ra(),p(),u.current=!1,h(!0),v.current=110;let N=0;function w(){if(u.current)return;if(N>=t.length){h(!1),i(-1);return}const S=t[N];if(!S||S.words.length===0){N++,w();return}const q=new SpeechSynthesisUtterance(S.spokenText),M=We();M&&(q.voice=M),q.lang=M?.lang||"es-ES",q.rate=Yo(),q.pitch=1;let C=!1,D=!1,R=!1,B=!1,I=0;const k=30,G=200;function H(z){const E=Math.max(0,Number(z)||0);let T=S.words[0];for(const P of S.words)if(P.charStart<=E+1)T=P;else break;return T}function ae(){if(B||R||u.current)return;B=!0;let z=0;for(let E=0;E<S.words.length;E++){const T=S.words[E],$=setTimeout(()=>{!u.current&&!R&&i(T.tokenIdx)},z);m.current.push($),z+=T.text.length*v.current+k,T.commaAfter&&(z+=G)}}q.onstart=()=>{if(C)return;C=!0,I=performance.now();const z=setTimeout(ae,350);m.current.push(z)},q.onboundary=z=>{if(u.current||typeof z.charIndex!="number")return;const E=H(z.charIndex);E&&(R=!0,i(E.tokenIdx))};const O=setTimeout(()=>{!C&&!u.current&&(C=!0,I=performance.now(),ae())},500);m.current.push(O);function F(){if(D||(D=!0,u.current))return;if(I>0){const E=performance.now()-I,T=S.words.reduce((ce,ea)=>ce+ea.text.length,0),P=S.words.filter(ce=>ce.commaAfter).length,$=S.words.length*k+P*G,le=Math.max(100,E-$);if(T>0){const ce=le/T;ce>=40&&ce<=300&&(v.current=ce*.6+v.current*.4)}}p(),N++;const z=setTimeout(w,30);m.current.push(z)}q.onend=F,q.onerror=F;const J=Math.max(5e3,S.spokenText.length*220),b=setTimeout(F,J);m.current.push(b),window.speechSynthesis.speak(q)}w()}return f.useEffect(()=>{function x(){u.current=!0,p(),h(!1),i(-1)}return window.addEventListener?.("learn-spanish-audio-stop",x),()=>{u.current=!0,p(),window.removeEventListener?.("learn-spanish-audio-stop",x),window.speechSynthesis?.cancel()}},[]),f.useEffect(()=>{if(r<0)return;const x=c.current[r];if(!x||typeof x.getBoundingClientRect!="function")return;const N=x.getBoundingClientRect(),w=window.innerHeight||document.documentElement.clientHeight;(N.bottom>w-100||N.top<80)&&x.scrollIntoView({behavior:"smooth",block:"center"})},[r]),typeof window<"u"&&!window.speechSynthesis?e.jsxs("p",{className:s,children:[e.jsx("button",{className:"speak-btn speak-btn-sm paragraph-speak",onClick:x=>{x.stopPropagation(),wa("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"})},"aria-label":"Audio not supported",title:"Audio no disponible",children:e.jsx(Ya,{size:12})}),e.jsx(K,{text:a})]}):e.jsxs("p",{className:`${s} karaoke-paragraph ${l?"is-playing":""}`,children:[e.jsx("button",{className:`speak-btn speak-btn-sm paragraph-speak ${l?"playing":""}`,onClick:g,onPointerDown:x=>x.stopPropagation(),"aria-label":l?"Stop":"Play audio with highlighting",title:l?"Detener":"Escuchar con resaltado",children:e.jsx(Ya,{size:12})}),n.map((x,N)=>{if(!x.isWord)return e.jsx("span",{className:"kt-space",children:x.text},N);const w=N===r;return e.jsx("span",{ref:S=>c.current[N]=S,className:`kt-word ${w?"kt-active":""}`,"data-dict-word":x.text,children:x.text},N)})]})}function X({text:a,size:s="sm",className:o=""}){const[n,t]=f.useState(!1);f.useEffect(()=>{function i(){t(!1)}return window.addEventListener?.("learn-spanish-audio-stop",i),()=>window.removeEventListener?.("learn-spanish-audio-stop",i)},[]);function r(i){if(i.stopPropagation(),typeof window>"u"||!window.speechSynthesis){wa("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(no(),n){ra(),t(!1);return}ra(),t(!0),Jo(a,{onend:()=>t(!1),onerror:l=>{t(!1),l?.error&&l.error!=="canceled"&&l.error!=="interrupted"&&wa(`Error al leer: ${l.error}. Asegurate de tener una voz en espanol instalada.`,{title:"Audio necesita atencion",tone:"warning"})}})}return e.jsx("button",{className:`speak-btn speak-btn-${s} ${n?"playing":""} ${o}`,onClick:r,onPointerDown:i=>i.stopPropagation(),"aria-label":n?"Stop":"Play audio",title:n?"Detener":"Escuchar",children:e.jsx(Ya,{size:s==="sm"?12:14})})}function Ws({settings:a,onChange:s}){const[o,n]=f.useState(()=>Mo());f.useEffect(()=>{ta(a)},[a]),f.useEffect(()=>{function r(){n(Mo())}if(r(),typeof window<"u"&&window.speechSynthesis){window.speechSynthesis.addEventListener?.("voiceschanged",r);const i=setTimeout(r,600);return()=>{clearTimeout(i),window.speechSynthesis.removeEventListener?.("voiceschanged",r)}}},[]);function t(r){const i={...a,...r};ta(i),s?.(i)}return e.jsxs("div",{className:"audio-settings","aria-label":"Audio settings",children:[e.jsxs("div",{className:"audio-settings-label",children:[e.jsx(Ho,{size:14}),"Audio"]}),e.jsxs("select",{className:"audio-rate-select",value:String(a.rate),onChange:r=>t({rate:Number(r.target.value)}),"aria-label":"Audio speed",children:[e.jsx("option",{value:"0.7",children:"0.70x"}),e.jsx("option",{value:"0.85",children:"0.85x"}),e.jsx("option",{value:"1",children:"1.00x"}),e.jsx("option",{value:"1.15",children:"1.15x"})]}),e.jsxs("select",{className:"audio-voice-select",value:a.voiceURI||"",onChange:r=>t({voiceURI:r.target.value}),"aria-label":"Spanish voice",children:[e.jsx("option",{value:"",children:"Voz espanola"}),o.map(r=>e.jsxs("option",{value:r.voiceURI,children:[r.name," (",r.lang,")"]},r.voiceURI))]})]})}function xe({es:a,en:s,esClass:o="vu-ex-es",enClass:n="vu-ex-en"}){const t=(a||"").length,r=(s||"").length;return t<=18&&r<=18&&t+r<=36?e.jsxs("div",{className:`${o} inline-pair`,children:[e.jsx(X,{text:a}),e.jsx(K,{text:a})," ",e.jsxs("span",{className:`${n} inline-en`,children:["(",s,")"]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:o,children:[e.jsx(X,{text:a}),e.jsx(K,{text:a})]}),e.jsx("div",{className:n,children:s})]})}const _s=`
