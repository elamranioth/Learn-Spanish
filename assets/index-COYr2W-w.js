...
.indicative-ref-table-shell thead th {
  background: var(--green);
  color: #fff;
  padding: 9px 11px;
  text-align: left;
...
.indicative-ref-table-shell tbody th,
...
.indicative-ref-table-shell tbody tr:last-child th,
.indicative-ref-table-shell tbody tr:last-child td {
  border-bottom: 0;
}
.indicative-ref-table-shell tbody th,
...
.indicative-reference-table-grid.single {
  grid-template-columns: 1fr;
}
...
.indicative-ref-table-card.merged {
  max-width: 100%;
}
.indicative-ref-table-card.merged h5 {
  display: none;
}
...
.indicative-ref-table-card.merged .indicative-ref-table-shell table {
  min-width: 0;
  table-layout: fixed;
}
.indicative-ref-table-card.merged thead th:first-child,
.indicative-ref-table-card.merged tbody th {
  width: 22%;
}
.indicative-ref-table-card.merged thead th:not(:first-child),
.indicative-ref-table-card.merged tbody td {
  text-align: center;
}
.indicative-ref-table-card.merged tbody td {
  color: var(--ink);
...
.indicative-ref-table-card.merged .render-form {
  white-space: nowrap;
}
...
@media (max-width: 700px) {
  ...
  .indicative-ref-table-card.merged .indicative-ref-table-shell thead th {
    padding: 8px 4px;
    font-size: 10px;
    letter-spacing: 0.04em;
  }
  .indicative-ref-table-card.merged .indicative-ref-table-shell tbody th,
  .indicative-ref-table-card.merged .indicative-ref-table-shell td {
    padding: 9px 4px;
  }
  .indicative-ref-table-card.merged thead th:first-child,
  .indicative-ref-table-card.merged tbody th {
...
.book-root.boox-mode .indicative-ref-table-shell thead th {
  background: #000000 !important;
  color: #ffffff !important;
}
.book-root.boox-mode .indicative-ref-table-shell tbody th,
.book-root.boox-mode .indicative-ref-table-shell td {
  background: #ffffff !important;
}
.book-root.boox-mode .indicative-ref-table-card.merged .indicative-ref-table-shell table {
  min-width: 0 !important;
  table-layout: fixed;
}
.book-root.boox-mode .indicative-ref-table-card.merged thead th:first-child,
.book-root.boox-mode .indicative-ref-table-card.merged tbody th {
  width: 22%;
}
.book-root.boox-mode .indicative-ref-table-card.merged thead th:not(:first-child),
.book-root.boox-mode .indicative-ref-table-card.merged tbody td {
...
@media (max-width: 700px) {
  ...
  .tense-group-table .render-form,
  .tense-mobile-form .render-form,
  .lesson-table-card-value .render-form {
    max-width: 100%;
  }
  .tense-group-table .speak-btn,
  .tense-mobile-form .speak-btn,
  .lesson-table-card-value .speak-btn {
...
@media (min-width: 560px) and (max-width: 700px) and (min-height: 850px) {
  .book-page {
  ...
  .verb-table-block .tense-group-table th,
  .verb-table-block .tense-group-table td {
    padding: 8px 4px !important;
    overflow: hidden !important;
  }
  .verb-table-block .tense-group-table thead th {
  ...
  .verb-table-block .tense-group-table tbody th.tg-pronoun {
    font-size: 16px !important;
    line-height: 1.15 !important;
    white-space: normal !important;
  }
  .verb-table-block .tense-group-table tbody td.tg-form {
...
.device-reader-tablet .indicative-ref-table-card.merged .indicative-ref-table-shell table {
  min-width: 0;
  table-layout: fixed;
}

.device-reader-tablet .indicative-ref-table-card.merged tbody td {
  font-size: clamp(17px, 2.2vw, 21px);
}

.device-reader-tablet .indicative-reference-tabs {
