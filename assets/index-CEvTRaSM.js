...
import{r as p,j as e,R as ee,c as ws}from"./react-iLQ0ojkV.js";import{X as Me,G as ht,C as Pe,B as ya,T as ks,a as oo,b as js,Z as dt,c as Ns,d as bn,D as xn,H as vn,V as ct,S as ze,M as zs,L as Ta,e as yn,f as Co,g as wn,h as Xa,i as Ma,j as Ss,k as Is,l as Cs,m as xo,n as vo,o as To,N as kn,R as gt,p as no}from"./icons-Dix0EpQo.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function o(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=o(s);fetch(s.href,r)}})();function Es(){typeof window>"u"||!("serviceWorker"in navigator)||window.addEventListener("load",()=>{const a="/Learn-Spanish/";navigator.serviceWorker.register(`${a}sw.js?v=${encodeURIComponent("2026-06-05T19:22:58.498Z")}`,{scope:a,updateViaCache:"none"}).then(o=>{function n(s){s?.postMessage?.({type:"SKIP_WAITING"}),window.dispatchEvent(new CustomEvent("learn-spanish-update-ready",{detail:{worker:s}}))}o.waiting&&navigator.serviceWorker.controller&&n(o.waiting),o.addEventListener("updatefound",()=>{const s=o.installing;s&&s.addEventListener("statechange",()=>{s.state==="installed"&&navigator.serviceWorker.controller&&n(s)})}),o.update().catch(()=>{})}).catch(()=>{}),navigator.serviceWorker.addEventListener("controllerchange",()=>{window.__learnSpanishRefreshing||(window.__learnSpanishRefreshing=!0,window.location.reload())})})}const qs="modulepreload",As=function(a){return"/Learn-Spanish/"+a},$t={},Le=function(t,o,n){let s=Promise.resolve();if(o&&o.length>0){let h=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),d=i?.nonce||i?.getAttribute("nonce");s=h(o.map(c=>{if(c=As(c),c in $t)return;$t[c]=!0;const m=c.endsWith(".css"),u=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const y=document.createElement("link");if(y.rel=m?"stylesheet":qs,m||(y.as="script"),y.crossOrigin="",y.href=c,d&&y.setAttribute("nonce",d),document.head.appendChild(y),m)return new Promise((j,E)=>{y.addEventListener("load",j),y.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=i,window.dispatchEvent(d),!d.defaultPrevented)throw i}return s.then(i=>{for(const d of i||[])d.status==="rejected"&&r(d.reason);return t().catch(r)})};function Eo(a,t={}){typeof window>"u"||window.dispatchEvent(new CustomEvent("learn-spanish-message",{detail:{id:`${Date.now()}-${Math.random().toString(16).slice(2)}`,title:t.title||"Notice",message:a,tone:t.tone||"info",timeout:t.timeout||5200}}))}function Ts(){const[a,t]=p.useState([]);return p.useEffect(()=>{function o(n){const s=n.detail||{};s.message&&(t(r=>[s,...r].slice(0,3)),s.timeout!==1/0&&window.setTimeout(()=>{t(r=>r.filter(i=>i.id!==s.id))},s.timeout||5200))}return window.addEventListener("learn-spanish-message",o),()=>window.removeEventListener("learn-spanish-message",o)},[]),a.length?e.jsx("div",{className:"app-message-stack","aria-live":"polite","aria-atomic":"false",children:a.map(o=>e.jsxs("div",{className:`app-message app-message-${o.tone||"info"}`,children:[e.jsxs("div",{children:[e.jsx("span",{className:"app-message-title",children:o.title}),e.jsx("p",{children:o.message})]}),e.jsx("button",{type:"button",className:"app-message-close",onClick:()=>t(n=>n.filter(s=>s.id!==o.id)),"aria-label":"Dismiss message",children:e.jsx(Me,{size:14})})]},o.id))}):null}function Ls({insights:a=[],onAction:t}){return a.length?e.jsxs("section",{className:"teacher-panel","aria-label":"Teacher recommendations",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(ht,{size:18}),"Teacher notes"]}),e.jsx("div",{className:"teacher-card-grid",children:a.map(o=>e.jsxs("button",{className:"teacher-card",onClick:()=>t?.(o.action),children:[e.jsx("span",{className:"teacher-card-title",children:o.title}),e.jsx("span",{className:"teacher-card-detail",children:o.detail}),e.jsxs("span",{className:"teacher-card-action",children:[o.actionLabel||"Open",e.jsx(Pe,{size:14})]})]},o.key))})]}):null}const Ka="study-time-v1",ft=240;function Lo(a=new Date){return a.toISOString().slice(0,10)}function Ps(a){if(!a||typeof a!="object")return null;const t=String(a.id||"").trim();if(!t)return null;const o=Math.max(0,Math.floor(Number(a.seconds)||0));return o?{id:t,chapterId:String(a.chapterId||"unknown"),date:a.date||Lo(new Date(Number(a.startedAt)||Date.now())),seconds:o,startedAt:Number(a.startedAt)||Number(a.updatedAt)||Date.now(),updatedAt:Number(a.updatedAt)||Number(a.startedAt)||Date.now()}:null}function Ms(a={}){return(Array.isArray(a.sessions)?a.sessions:[]).map(Ps).filter(Boolean).sort((t,o)=>(o.updatedAt||0)-(t.updatedAt||0)).slice(0,ft)}function ma(a,t=()=>!0){return a.reduce((o,n)=>o+(t(n)?n.seconds:0),0)}function _s(a){const t={};for(const o of a)t[o.chapterId]=(t[o.chapterId]||0)+o.seconds;return t}function La(a={}){const t=Lo(),o=a.date===t?a.date:t,n=a.date===t?Math.max(0,Number(a.todaySeconds)||0):0,s=Ms(a);return{totalSeconds:Math.max(0,Number(a.totalSeconds)||0),todaySeconds:n,date:o,byChapter:a.byChapter&&typeof a.byChapter=="object"?a.byChapter:{},sessions:s,updatedAt:a.updatedAt||Date.now()}}function jn(a={},t={}){const o=La(a),n=La(t),s=new Map;for(const v of[...n.sessions,...o.sessions]){const z=s.get(v.id);(!z||(v.updatedAt||0)>=(z.updatedAt||0))&&s.set(v.id,v)}const r=[...s.values()].sort((v,z)=>(z.updatedAt||0)-(v.updatedAt||0)).slice(0,ft),i=ma(o.sessions),d=ma(n.sessions),h=ma(r),c=Lo(),m=ma(o.sessions,v=>v.date===c),u=ma(n.sessions,v=>v.date===c),y=ma(r,v=>v.date===c),j=_s(r),E={...j};for(const v of new Set([...Object.keys(n.byChapter||{}),...Object.keys(o.byChapter||{})])){const z=ma(o.sessions,_=>_.chapterId===v),G=ma(n.sessions,_=>_.chapterId===v),F=Math.max(0,(Number(o.byChapter?.[v])||0)-z),P=Math.max(0,(Number(n.byChapter?.[v])||0)-G);E[v]=Math.max(F,P)+(j[v]||0)}const b=Math.max(Math.max(0,o.totalSeconds-i),Math.max(0,n.totalSeconds-d)),k=Math.max(Math.max(0,o.todaySeconds-m),Math.max(0,n.todaySeconds-u));return{totalSeconds:b+h,todaySeconds:k+y,date:c,byChapter:E,sessions:r,updatedAt:Math.max(Number(o.updatedAt)||0,Number(n.updatedAt)||0,Date.now())}}function Ds(a={},t,o,n=Date.now()){const s=La(a),r=Lo(new Date(n)),i=o||`${r}-${t||"lesson"}`,d=[...s.sessions],h=d.findIndex(c=>c.id===i);return h>=0?d[h]={...d[h],chapterId:t,date:r,seconds:d[h].seconds+1,updatedAt:n}:d.unshift({id:i,chapterId:t,date:r,seconds:1,startedAt:n,updatedAt:n}),{...s,totalSeconds:s.totalSeconds+1,todaySeconds:s.date===r?s.todaySeconds+1:1,date:r,byChapter:{...s.byChapter,[t]:(Number(s.byChapter?.[t])||0)+1},sessions:d.sort((c,m)=>(m.updatedAt||0)-(c.updatedAt||0)).slice(0,ft),updatedAt:n}}function va(a=0){const t=Math.max(0,Math.floor(Number(a)||0)),o=Math.floor(t/3600),n=Math.floor(t%3600/60);return o>0?`${o}h ${String(n).padStart(2,"0")}m`:n>0?`${n}m`:`${t}s`}function Zo({icon:a,label:t,value:o,detail:n}){return e.jsxs("div",{className:"teacher-metric",children:[e.jsx(a,{size:16}),e.jsx("span",{children:t}),e.jsx("strong",{children:o}),e.jsx("em",{children:n})]})}function Rs({totalLessons:a,visitedCount:t,savedWordsCount:o,levelFilter:n,palabrasSummary:s,lessonSummary:r,memoriaSummary:i,learnerProfile:d,reviewQueue:h,studyTime:c,dailyPlan:m,dailyProgress:u,teacherInsights:y,sectionProgress:j,recommendations:E,onStart:b,onStartDaily:k,onDailyStep:v,onOpenMemoria:z,onOpenPalabras:G,onOpenVerb:F,onOpenReading:P,onSelectChapter:_,onTeacherAction:N}){const U=a?Math.round(t/a*100):0,H=m.find(C=>!C.complete)||m[0],w=y?.[0]||{title:"Begin today gently",detail:"Open the next lesson, read one page, then save one useful word in Memoria.",action:"daily",actionLabel:"Start"},B=r?.mastered||0,V=w.action||"daily";return e.jsxs("article",{className:"chapter-body home-dashboard",children:[e.jsxs("header",{className:"home-hero",children:[e.jsxs("div",{className:"home-kicker",children:[e.jsx(ht,{size:18}),"Daily Teacher Mode"]}),e.jsx("h1",{className:"home-title",children:"Lexiora"}),e.jsx("p",{className:"home-subtitle",children:"A calm Spanish study room: one lesson, one review queue, one clear next action."}),e.jsxs("div",{className:"home-actions",children:[e.jsxs("button",{className:"home-primary",onClick:k||b,children:["Start Daily Lesson",e.jsx(Pe,{size:16})]}),e.jsxs("button",{className:"home-secondary",onClick:z,children:[e.jsx(ya,{size:15}),"Memoria"]})]})]}),e.jsxs("section",{className:"daily-teacher-panel","aria-label":"Daily teacher mode",children:[e.jsxs("div",{className:"daily-teacher-main",children:[e.jsxs("span",{className:"home-section-heading",children:[e.jsx(ks,{size:18}),"Teacher focus"]}),e.jsx("h2",{children:w.title}),e.jsx("p",{children:w.detail}),e.jsxs("div",{className:"daily-teacher-actions",children:[e.jsxs("button",{onClick:()=>N?.(V),children:[w.actionLabel||"Open",e.jsx(Pe,{size:15})]}),H&&e.jsxs("button",{className:"secondary",onClick:()=>v(H.key),children:["Next: ",H.title]})]})]}),e.jsxs("div",{className:"daily-teacher-card",children:[e.jsxs("span",{children:[u.completed," / ",u.total]}),e.jsx("strong",{children:"Today"}),e.jsxs("em",{children:[u.streak," day streak"]})]})]}),e.jsxs("section",{className:"teacher-metrics","aria-label":"Today's study metrics",children:[e.jsx(Zo,{icon:oo,label:"Today",value:va(c.todaySeconds),detail:`${va(c.totalSeconds)} total`}),e.jsx(Zo,{icon:js,label:"Mastery",value:B,detail:`${r.understood} understood`}),e.jsx(Zo,{icon:ya,label:"Memoria",value:o,detail:`${i.due} due`})]}),e.jsx(Ls,{insights:y,onAction:N}),e.jsxs("section",{className:"home-stats","aria-label":"Study progress",children:[e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Progreso"}),e.jsxs("strong",{children:[U,"%"]}),e.jsxs("span",{children:[t," / ",a," lecciones"]})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Nivel"}),e.jsx("strong",{children:n==="ALL"?"Todo":n}),e.jsx("span",{children:"Filtro activo"})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Palabras due"}),e.jsx("strong",{children:s.due}),e.jsxs("span",{children:[s.mastered," dominadas"]})]}),e.jsxs("div",{className:"home-stat",children:[e.jsx("span",{className:"home-stat-label",children:"Lecciones"}),e.jsx("strong",{children:r.understood}),e.jsxs("span",{children:[r.read," leidas"]})]})]}),e.jsxs("section",{className:"home-daily",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(dt,{size:18}),"Ruta diaria"]}),e.jsx("div",{className:"home-daily-grid",children:m.map(C=>e.jsxs("button",{className:`home-daily-step ${C.complete?"complete":""}`,onClick:()=>v(C.key),children:[e.jsx("span",{children:C.index}),e.jsx("strong",{children:C.title}),e.jsx("em",{children:C.detail}),e.jsx("small",{children:C.complete?"Done":"Open"})]},C.key))})]}),e.jsxs("section",{className:"home-review-queue",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(Ns,{size:18}),"Cola de repaso"]}),e.jsx("div",{className:"home-review-list",children:h.slice(0,8).map((C,O)=>e.jsxs("button",{onClick:()=>C.chapter?_(C.chapter):z(),children:[e.jsx("span",{className:`review-type ${C.type}`,children:C.type}),e.jsx("strong",{children:C.title}),e.jsx("em",{children:C.detail})]},`${C.type}-${C.title}-${O}`))}),e.jsxs("div",{className:"home-review-summary",children:[d.vocabulary.due," vocabulary due - ",d.chapters.unvisited," lesson groups to open"]})]}),e.jsxs("section",{className:"home-progress-map",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(bn,{size:18}),"Mapa de progreso"]}),e.jsx("div",{className:"home-progress-list",children:j.map(C=>{const O=C.total?Math.round(C.visited/C.total*100):0;return e.jsxs("div",{className:"home-progress-row",children:[e.jsxs("div",{className:"home-progress-top",children:[e.jsx("span",{children:C.label}),e.jsxs("strong",{children:[C.visited," / ",C.total]})]}),e.jsx("div",{className:"home-progress-track",children:e.jsx("span",{style:{width:`${O}%`}})})]},C.id)})})]}),e.jsxs("section",{className:"home-path",children:[e.jsxs("div",{className:"home-section-heading",children:[e.jsx(oo,{size:18}),"Siguiente lectura"]}),e.jsx("div",{className:"home-recommendations",children:E.map((C,O)=>e.jsxs("button",{className:"home-rec",onClick:()=>_(C),children:[e.jsx("span",{className:"home-rec-index",children:String(O+1).padStart(2,"0")}),e.jsxs("span",{className:"home-rec-main",children:[e.jsx("span",{className:"home-rec-title",children:C.title}),e.jsxs("span",{className:"home-rec-meta",children:[C.sectionLabel," - ",C.level]})]}),e.jsx(Pe,{size:16})]},C.id))})]})]})}function Gs({installReady:a,installMessage:t,onInstall:o,onDismiss:n}){return e.jsxs("div",{className:"install-banner",children:[e.jsxs("div",{className:"resume-banner-text",children:[e.jsx("span",{className:"resume-banner-label",children:"Install Lexiora"}),e.jsx("span",{className:"resume-banner-title",children:a?"Add the app to this device":"Add to Home Screen if your browser hides the icon"}),t&&e.jsx("span",{className:"install-banner-message",children:t})]}),e.jsxs("div",{className:"resume-banner-actions",children:[e.jsxs("button",{className:"resume-btn-primary install-btn-primary",onClick:o,children:[e.jsx(xn,{size:15}),"Install"]}),e.jsx("button",{className:"resume-btn-dismiss",onClick:n,"aria-label":"Dismiss install banner",children:e.jsx(Me,{size:15})})]})]})}let ba=null,Ot=!1,Pa={rate:.85,voiceURI:""};function Nn(){return Math.max(.65,Math.min(1.25,Number(Pa.rate)||.85))}function Za(a={}){Pa={...Pa,...a,rate:Math.max(.65,Math.min(1.25,Number(a.rate??Pa.rate)||.85))},ba=null}function zn(){return typeof window>"u"||!window.speechSynthesis?[]:window.speechSynthesis.getVoices()||[]}function Bt(){return zn().filter(a=>a.lang&&a.lang.toLowerCase().startsWith("es")||/spanish|espanol|espaÃ±ol/i.test(a.name||""))}function qa(){if(typeof window>"u"||!window.speechSynthesis)return null;if(ba)return ba;const a=zn();if(a.length===0)return null;if(Pa.voiceURI){const n=a.find(s=>s.voiceURI===Pa.voiceURI);if(n)return ba=n,n}const t=["es-ES","es-MX","es-US","es-AR","es-CO","es-419","es"];for(const n of t){const s=a.find(r=>r.lang&&r.lang.toLowerCase().startsWith(n.toLowerCase()));if(s)return ba=s,s}const o=a.find(n=>/spanish|español/i.test(n.name||""));return o?(ba=o,o):null}typeof window<"u"&&window.speechSynthesis&&(window.speechSynthesis.addEventListener?.("voiceschanged",()=>{ba=null,qa()}),qa(),setTimeout(qa,250),setTimeout(qa,1e3));function bt(){if(!Ot&&!(typeof window>"u"||!window.speechSynthesis))try{const a=new SpeechSynthesisUtterance(" ");a.volume=0,a.rate=1,window.speechSynthesis.speak(a),Ot=!0}catch{}}function to(){try{window.speechSynthesis?.cancel(),window.dispatchEvent?.(new CustomEvent("learn-spanish-audio-stop"))}catch{}}function Sn(a,t={}){if(typeof window>"u"||!window.speechSynthesis||!a)return t.onerror&&t.onerror({error:"no-speechSynthesis"}),null;try{window.speechSynthesis.cancel();const o=new SpeechSynthesisUtterance(a),n=qa();n&&(o.voice=n),o.lang=n?.lang||"es-ES",o.rate=t.rate??Nn(),o.pitch=t.pitch??1,o.volume=1,t.onend&&(o.onend=t.onend),t.onerror&&(o.onerror=i=>{console.warn("[speech] error:",i?.error||"unknown",{text:a.slice(0,30),voice:n?.name}),t.onerror(i)}),t.onboundary&&(o.onboundary=t.onboundary),t.onstart&&(o.onstart=t.onstart),window.speechSynthesis.speak(o);const s=setInterval(()=>{if(!window.speechSynthesis.speaking){clearInterval(s);return}window.speechSynthesis.pause(),window.speechSynthesis.resume()},14e3),r=o.onend;return o.onend=i=>{clearInterval(s),r&&r(i)},o}catch(o){return console.warn("[speech] threw:",o),t.onerror&&t.onerror({error:o.message}),null}}const Ft=/([\p{L}\p{N}]+)|([^\p{L}\p{N}]+)/gu;function In(a){const t=[],o=String(a||"");let n;for(Ft.lastIndex=0;(n=Ft.exec(o))!==null;)t.push({text:n[0],isWord:!!n[1],charStart:n.index});return t}function de({text:a}){const t=p.useMemo(()=>In(a),[a]);return e.jsx(e.Fragment,{children:t.map((o,n)=>o.isWord?e.jsx("span",{className:"dict-word-token","data-dict-word":o.text,children:o.text},n):e.jsx("span",{children:o.text},n))})}function so({text:a,paragraphClass:t="reading-paragraph",firstParagraph:o=!1}){const n=p.useMemo(()=>In(a),[a]),s=p.useMemo(()=>{const b=[];let k="",v=[],z=-1;function G(){v.length>0&&b.push({spokenText:k.trim(),words:v}),k="",v=[],z=-1}for(let F=0;F<n.length;F++){const P=n[F];if(!P.isWord&&v.length===0&&/^\s+$/.test(P.text))continue;const _=k.length;k+=P.text,P.isWord?(v.push({tokenIdx:F,text:P.text,charStart:_,charEnd:_+P.text.length,commaAfter:!1}),z=v.length-1):(/,/.test(P.text)&&z>=0&&(v[z].commaAfter=!0),/[.!?;:]/.test(P.text)&&G())}return G(),b},[n]),[r,i]=p.useState(-1),[d,h]=p.useState(!1),c=ee.useRef([]),m=ee.useRef([]),u=ee.useRef(!1),y=ee.useRef(110);function j(){m.current.forEach(clearTimeout),m.current=[]}function E(b){if(b.stopPropagation(),typeof window>"u"||!window.speechSynthesis){Eo("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(bt(),d){u.current=!0,to(),j(),h(!1),i(-1);return}if(s.length===0)return;to(),j(),u.current=!1,h(!0),y.current=110;let k=0;function v(){if(u.current)return;if(k>=s.length){h(!1),i(-1);return}const z=s[k];if(!z||z.words.length===0){k++,v();return}const G=new SpeechSynthesisUtterance(z.spokenText),F=qa();F&&(G.voice=F),G.lang=F?.lang||"es-ES",G.rate=Nn(),G.pitch=1;let P=!1,_=!1,N=!1,U=!1,H=0;const w=30,B=200;function V($){const f=Math.max(0,Number($)||0);let M=z.words[0];for(const J of z.words)if(J.charStart<=f+1)M=J;else break;return M}function C(){if(U||N||u.current)return;U=!0;let $=0;for(let f=0;f<z.words.length;f++){const M=z.words[f],X=setTimeout(()=>{!u.current&&!N&&i(M.tokenIdx)},$);m.current.push(X),$+=M.text.length*y.current+w,M.commaAfter&&($+=B)}}G.onstart=()=>{if(P)return;P=!0,H=performance.now();const $=setTimeout(C,350);m.current.push($)},G.onboundary=$=>{if(u.current||typeof $.charIndex!="number")return;const f=V($.charIndex);f&&(N=!0,i(f.tokenIdx))};const O=setTimeout(()=>{!P&&!u.current&&(P=!0,H=performance.now(),C())},500);m.current.push(O);function Q(){if(_||(_=!0,u.current))return;if(H>0){const f=performance.now()-H,M=z.words.reduce((Y,Se)=>Y+Se.text.length,0),J=z.words.filter(Y=>Y.commaAfter).length,X=z.words.length*w+J*B,K=Math.max(100,f-X);if(M>0){const Y=K/M;Y>=40&&Y<=300&&(y.current=Y*.6+y.current*.4)}}j(),k++;const $=setTimeout(v,30);m.current.push($)}G.onend=Q,G.onerror=Q;const D=Math.max(5e3,z.spokenText.length*220),W=setTimeout(Q,D);m.current.push(W),window.speechSynthesis.speak(G)}v()}return p.useEffect(()=>{function b(){u.current=!0,j(),h(!1),i(-1)}return window.addEventListener?.("learn-spanish-audio-stop",b),()=>{u.current=!0,j(),window.removeEventListener?.("learn-spanish-audio-stop",b),window.speechSynthesis?.cancel()}},[]),p.useEffect(()=>{if(r<0)return;const b=c.current[r];if(!b||typeof b.getBoundingClientRect!="function")return;const k=b.getBoundingClientRect(),v=window.innerHeight||document.documentElement.clientHeight;(k.bottom>v-100||k.top<80)&&b.scrollIntoView({behavior:"smooth",block:"center"})},[r]),typeof window<"u"&&!window.speechSynthesis?e.jsxs("p",{className:t,children:[e.jsx("button",{className:"speak-btn speak-btn-sm paragraph-speak",onClick:b=>{b.stopPropagation(),Eo("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"})},"aria-label":"Audio not supported",title:"Audio no disponible",children:e.jsx(ct,{size:12})}),e.jsx(de,{text:a})]}):e.jsxs("p",{className:`${t} karaoke-paragraph ${d?"is-playing":""}`,children:[e.jsx("button",{className:`speak-btn speak-btn-sm paragraph-speak ${d?"playing":""}`,onClick:E,onPointerDown:b=>b.stopPropagation(),"aria-label":d?"Stop":"Play audio with highlighting",title:d?"Detener":"Escuchar con resaltado",children:e.jsx(ct,{size:12})}),n.map((b,k)=>{if(!b.isWord)return e.jsx("span",{className:"kt-space",children:b.text},k);const v=k===r;return e.jsx("span",{ref:z=>c.current[k]=z,className:`kt-word ${v?"kt-active":""}`,"data-dict-word":b.text,children:b.text},k)})]})}function ie({text:a,size:t="sm",className:o=""}){const[n,s]=p.useState(!1);p.useEffect(()=>{function i(){s(!1)}return window.addEventListener?.("learn-spanish-audio-stop",i),()=>window.removeEventListener?.("learn-spanish-audio-stop",i)},[]);function r(i){if(i.stopPropagation(),typeof window>"u"||!window.speechSynthesis){Eo("Tu navegador no soporta lectura en voz alta.",{title:"Audio no disponible",tone:"warning"});return}if(bt(),n){to(),s(!1);return}to(),s(!0),Sn(a,{onend:()=>s(!1),onerror:d=>{s(!1),d?.error&&d.error!=="canceled"&&d.error!=="interrupted"&&Eo(`Error al leer: ${d.error}. Asegurate de tener una voz en espanol instalada.`,{title:"Audio necesita atencion",tone:"warning"})}})}return e.jsx("button",{className:`speak-btn speak-btn-${t} ${n?"playing":""} ${o}`,onClick:r,onPointerDown:i=>i.stopPropagation(),"aria-label":n?"Stop":"Play audio",title:n?"Detener":"Escuchar",children:e.jsx(ct,{size:t==="sm"?12:14})})}function Us({settings:a,onChange:t}){const[o,n]=p.useState(()=>Bt());p.useEffect(()=>{Za(a)},[a]),p.useEffect(()=>{function r(){n(Bt())}if(r(),typeof window<"u"&&window.speechSynthesis){window.speechSynthesis.addEventListener?.("voiceschanged",r);const i=setTimeout(r,600);return()=>{clearTimeout(i),window.speechSynthesis.removeEventListener?.("voiceschanged",r)}}},[]);function s(r){const i={...a,...r};Za(i),t?.(i)}return e.jsxs("div",{className:"audio-settings","aria-label":"Audio settings",children:[e.jsxs("div",{className:"audio-settings-label",children:[e.jsx(vn,{size:14}),"Audio"]}),e.jsxs("select",{className:"audio-rate-select",value:String(a.rate),onChange:r=>s({rate:Number(r.target.value)}),"aria-label":"Audio speed",children:[e.jsx("option",{value:"0.7",children:"0.70x"}),e.jsx("option",{value:"0.85",children:"0.85x"}),e.jsx("option",{value:"1",children:"1.00x"}),e.jsx("option",{value:"1.15",children:"1.15x"})]}),e.jsxs("select",{className:"audio-voice-select",value:a.voiceURI||"",onChange:r=>s({voiceURI:r.target.value}),"aria-label":"Spanish voice",children:[e.jsx("option",{value:"",children:"Voz espanola"}),o.map(r=>e.jsxs("option",{value:r.voiceURI,children:[r.name," (",r.lang,")"]},r.voiceURI))]})]})}function Ye({es:a,en:t,esClass:o="vu-ex-es",enClass:n="vu-ex-en"}){const s=(a||"").length,r=(t||"").length;return s<=18&&r<=18&&s+r<=36?e.jsxs("div",{className:`${o} inline-pair`,children:[e.jsx(ie,{text:a}),e.jsx(de,{text:a})," ",e.jsxs("span",{className:`${n} inline-en`,children:["(",t,")"]})]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:o,children:[e.jsx(ie,{text:a}),e.jsx(de,{text:a})]}),e.jsx("div",{className:n,children:t})]})}const $s=`
